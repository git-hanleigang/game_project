...
local SlideNode = util_require("views.lobby.SlideNode")
local Activity_NewPassBase_CountDownSlideNode = class("Activity_NewPassBase_CountDownSlideNode", SlideNode)

function Activity_NewPassBase_CountDownSlideNode:initView()
...
function Activity_NewPassBase_CountDownSlideNode:updateView()
    -- 计算倒计时
...
function Activity_NewPassBase_CountDownSlideNode:onExit()
    self:clearScheduler()
    Activity_NewPassBase_CountDownSlideNode.super.onExit(self)
end

function Activity_NewPassBase_CountDownSlideNode:clearScheduler()
...
return Activity_NewPassBase_CountDownSlideNode