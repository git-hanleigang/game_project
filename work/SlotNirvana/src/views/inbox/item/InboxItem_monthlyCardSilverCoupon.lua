...
local InboxItem_monthlyCardSilverCoupon = class("InboxItem_monthlyCardSilverCoupon", InboxItem_baseCoupon)

InboxItem_monthlyCardSilverCoupon.CSB_TYPE = {
    coin = "InBox/InboxItem_MonthlyCard_Sliver.csb",
    gem = "CommonButton/csb_inbox/Common_coupon_gem.csb",
    piggy = "CommonButton/csb_inbox/Common_coupon_piggy.csb"
}

function InboxItem_monthlyCardSilverCoupon:initView()
...
function InboxItem_monthlyCardSilverCoupon:iniTicketsNum()
...
function InboxItem_monthlyCardSilverCoupon:sendCollectMail()
...
return InboxItem_monthlyCardSilverCoupon
