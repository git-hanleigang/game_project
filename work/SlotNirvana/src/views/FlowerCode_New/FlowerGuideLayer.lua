...
function FlowerGuideLayer:ctor(_type)
    ...
    local path = "Flower/Activity/csd/node_Guide.csb"
    if globalData.slotRunData.isPortrait then
        path = "Flower/Activity/csd/node_Guide_vertical.csb"
        ratio = 0.8
    end
    if self._type == 2 then
        path = "Flower/Activity/csd/node_Guide_operation.csb"
        if globalData.slotRunData.isPortrait then
            path = "Flower/Activity/csd/node_Goperation_vertical.csb"
        end
    end
