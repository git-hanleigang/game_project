...
function FlowerBuyLayer:ctor(_type)
    ...
    local path = "Flower/Activity/csd/EasterSeason_Buy.csb"
    path_v = "Flower/Activity/csd/EasterSeason_Buy_vertical.csb"
    self.payInfo = {}
    self.index_list = {}
    ...
    if #self.payInfo == 1 then
        path = "Flower/Activity/csd/EasterSeason_Buy_2.csb"
        path_v = "Flower/Activity/csd/EasterSeason_Buy_vertical_2.csb"
    end
