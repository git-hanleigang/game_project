...
function FlowerRewardLayer:initDatas(itemList, clickFunc, flyCoins, skipRotate,isBig)
    ...
    --     isAutoScale = false
    -- end
    -- local path = "Activity/csd/EasterSeason_Reward_2.csb"
    -- self:createCsbNode(path, isAutoScale)
    -- if not skipRotate then
    --     util_rotateToLandscape(self.m_csbNode)
    ...
    self:setLandscapeCsbName("Activity/csd/EasterSeason_Reward_2.csb")
    self:setPortraitCsbName("Activity/csd/EasterSeason_Reward_2_shu.csb")
