...
-- 大厅轮播图
--
local LevelFirstCommomSaleSlideNode = class("LevelFirstCommomSaleSlideNode", util_require("base.BaseView"))

function LevelFirstCommomSaleSlideNode:initUI()
    self.m_saleData = G_GetMgr(G_REF.FirstCommonSale):getRunningData()
...
-- A组
function LevelFirstCommomSaleSlideNode:initViewA()
    ...
    self:createCsbNode(csbTheme .. "/Icons/FirstTimeSale_A_Slide.csb")
    self.m_discount = self:findChild("lb_desc")
    self:updateDisconut()
end

function LevelFirstCommomSaleSlideNode:updateDisconut()
...
-- B组
function LevelFirstCommomSaleSlideNode:initViewB()
    local csbTheme = "Promotion/FirstCommonSale_normal"
    if globalData.constantData.FIRST_COMMON_SALE_SPECIAL_THEME then
        csbTheme = "Promotion/FirstCommonSale_special"
    end
    self:createCsbNode(csbTheme .. "/Icons/FirstTimeSale_B_Slide.csb")
...
function LevelFirstCommomSaleSlideNode:updateCoin()
...
function LevelFirstCommomSaleSlideNode:updateDisconut_price()
...
--点击回调
function LevelFirstCommomSaleSlideNode:MyclickFunc()
...
function LevelFirstCommomSaleSlideNode:clickLayer(name)
...
function LevelFirstCommomSaleSlideNode:onEnter()
    LevelFirstCommomSaleSlideNode.super.onEnter(self)
...
return LevelFirstCommomSaleSlideNode
