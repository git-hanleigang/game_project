...
-- 排行榜界面
local rank_path = "CardRes/CardRank202303/CardRank/"
...
CardRankConfig.RankTopThreeCellLuaPath = "views.Card.CardRank202303.CardRankTopThreeCell"
CardRankConfig.RankRewardCellLuaPath = "views.Card.CardRank202303.CardRankRewardCell"
