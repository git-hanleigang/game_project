...
function CSMainBox:initSpine()
    ...
    self.m_spNormalBox = util_spineCreate(CardSeekerCfg.otherPath .. "spine/Seeker202304_Box_normal", true, true, 1)
    node_spine:addChild(self.m_spNormalBox)
    self.m_spSpecialBox = util_spineCreate(CardSeekerCfg.otherPath .. "spine/Seeker202304_Box_special", true, true, 1)
