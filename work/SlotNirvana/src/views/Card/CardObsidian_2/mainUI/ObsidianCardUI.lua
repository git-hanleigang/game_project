...
function ObsidianCardUI:getTitleLuaPath()
    return "views.Card.CardObsidian_2.mainUI.ObsidianCardTitle"
end

function ObsidianCardUI:getChipsLuaPath()
    return "views.Card.CardObsidian_2.mainUI.ObsidianCardChips"
end

function ObsidianCardUI:getTabLuaPath()
    return "views.Card.CardObsidian_2.mainUI.ObsidianCardTab"
end

function ObsidianCardUI:getTimeLuaPath()
    return "views.Card.CardObsidian_2.mainUI.ObsidianCardTime"
end
