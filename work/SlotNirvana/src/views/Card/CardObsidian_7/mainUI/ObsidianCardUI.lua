...
function ObsidianCardUI:onShowedCallFunc()
    ...
    self:palyTimeLimitExpansion()
end

function ObsidianCardUI:palyTimeLimitExpansion()
    ...
    local isComplete = data:isPhaseRewardCompleted(3)
    if isComplete then
        return
    end
    local limitExpansion = G_GetMgr(ACTIVITY_REF.TimeLimitExpansion)
    if not limitExpansion then
        return
    end
...
function ObsidianCardUI:getTitleLuaPath()
    return "views.Card.CardObsidian_7.mainUI.ObsidianCardTitle"
end

function ObsidianCardUI:getChipsLuaPath()
    return "views.Card.CardObsidian_7.mainUI.ObsidianCardChips"
end

function ObsidianCardUI:getTabLuaPath()
    return "views.Card.CardObsidian_7.mainUI.ObsidianCardTab"
end

function ObsidianCardUI:getTimeLuaPath()
    return "views.Card.CardObsidian_7.mainUI.ObsidianCardTime"
end
