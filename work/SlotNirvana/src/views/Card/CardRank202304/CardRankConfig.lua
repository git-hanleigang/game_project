...
-- 排行榜界面
local rank_path = "CardRes/CardRank202304/CardRank/"
...
CardRankConfig.RankTipUI = rank_path .. "Card_Rank_main_tip.csb"

CardRankConfig.RankTopThreeCellLuaPath = "views.Card.CardRank202304.CardRankTopThreeCell"
CardRankConfig.RankRewardCellLuaPath = "views.Card.CardRank202304.CardRankRewardCell"
