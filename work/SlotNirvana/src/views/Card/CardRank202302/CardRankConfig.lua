...
-- 排行榜界面
local rank_path = "CardRes/CardRank202302/CardRank/"
...
CardRankConfig.RankTopThreeCellLuaPath = "views.Card.CardRank202302.CardRankTopThreeCell"
CardRankConfig.RankRewardCellLuaPath = "views.Card.CardRank202302.CardRankRewardCell"
