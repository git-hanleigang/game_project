...
-- 排行榜界面
local rank_path = "CardRes/CardRank202401/CardRank/"
...
CardRankConfig.RankTopThreeCellLuaPath = "views.Card.CardRank202401.CardRankTopThreeCell"
CardRankConfig.RankRewardCellLuaPath = "views.Card.CardRank202401.CardRankRewardCell"
