...
function CSRewardUI:initRewards()
    ...
    local coinNum = winRewardData:getCoins() or 0
    local gemNum = winRewardData:getGems() or 0
    local items = winRewardData:getMergeItems()
...
function CSRewardUI:flyCoins(_flyCoinsEndCall)
    ...
    local coins = winRewardData:getCoins() or 0
    local gems = winRewardData:getGems() or 0
