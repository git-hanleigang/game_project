...
function ObsidianCardUI:getCsbPath()
    return string.format("CardRes/CardObsidian_%s/csb/main/ObsidianAlbum_layer_Spree.csb", self.m_seasonId)
end
...
function ObsidianCardUI:getTitleLuaPath()
    return "views.Card.CardObsidian_1.mainUI.ObsidianCardTitle"
end

function ObsidianCardUI:getChipsLuaPath()
    return "views.Card.CardObsidian_1.mainUI.ObsidianCardChips"
end

function ObsidianCardUI:getTabLuaPath()
    return "views.Card.CardObsidian_1.mainUI.ObsidianCardTab"
end

function ObsidianCardUI:getTimeLuaPath()
    return "views.Card.CardObsidian_1.mainUI.ObsidianCardTime"
end
