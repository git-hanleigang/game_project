...
function ObsidianCardRewardUI:initDatas(_rewardData, _callBack)
    ...
    local csbPath = "CardRes/CardObsidian_6/csb/reward/Season_Reward_normal.csb"
    if self.m_isTop then
        csbPath = "CardRes/CardObsidian_6/csb/reward/Season_Reward_high.csb"
    end
...
function ObsidianCardRewardUI:initTimeLimitExpansionLogo()
