...
function ObsidianCardUI:getTitleLuaPath()
    return "views.Card.CardObsidian_3.mainUI.ObsidianCardTitle"
end

function ObsidianCardUI:getChipsLuaPath()
    return "views.Card.CardObsidian_3.mainUI.ObsidianCardChips"
end

function ObsidianCardUI:getTabLuaPath()
    return "views.Card.CardObsidian_3.mainUI.ObsidianCardTab"
end

function ObsidianCardUI:getTimeLuaPath()
    return "views.Card.CardObsidian_3.mainUI.ObsidianCardTime"
end
