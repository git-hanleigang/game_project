...
function CardSpecialAlbumUI:initDatas(_index)
    ...
    self.m_pageNum = math.floor(#cards / CardSpecialClanCfg.pageCardNum + 0.5)
    ...
    self:setLandscapeCsbName("CardRes/" .. themeName .. "/csb/main/MagicAlbum_layer.csb")
end
...
function CardSpecialAlbumUI:initTitle()
...
function CardSpecialAlbumUI:initTabs()
    ...
    for i = 1, self.m_pageNum do
        ...
        self.m_tabs[i] = tab
        UIList[i] = {node = tab, size = tab:getTabSize()}
...
function CardSpecialAlbumUI:delPage()
    if self.m_bScrolling == true then
        return
    end
...
function CardSpecialAlbumUI:canClick()
    return true
end
...
function CardSpecialAlbumUI:baseTouchEvent(sender, eventType)
...
function CardSpecialAlbumUI:closeUI(_over)
    ...
    CardSpecialAlbumUI.super.closeUI(self, _over)
end

function CardSpecialAlbumUI:showGuide(_index)
...
function CardSpecialAlbumUI:checkGuide()
...
function CardSpecialAlbumUI:createLayout()
