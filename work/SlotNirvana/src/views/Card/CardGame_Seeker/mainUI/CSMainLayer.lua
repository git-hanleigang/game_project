...
--     return CardSeekerCfg.otherPath .. "music/bgm.mp3"
-- end
...
function CSMainLayer:initCsbNodes()
    ...
    self.m_nodeNpc = self:findChild("Node_Npc_Cat")
...
function CSMainLayer:createBoxReward(_boxIndex, _boxData, _isGrey)
    ...
    util_setCascadeColorEnabledRescursion(parent, true)
    return rewardNode
end
...
function CSMainLayer:getBoxRewardByIndex(_boxIndex)
    ...
    return parent:getChildByName("BoxReward")
end
...
function CSMainLayer:setBtnGoClickStatus(_btnStatus)
    ...
    if _btnStatus == true and not winData:hasRewards() then
        return
    end
