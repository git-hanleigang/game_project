-- 集卡排行榜 玩法简介
local CardRankConfig = require("views.Card.CardRank202204.CardRankConfig")
...
function CardRankHelpUI:initView()
    ...
    local page1 = util_createView("views.Card.CardRank202204.CardRankHelpItemUI", 1)
    if not tolua.isnull(page1) then
        page1:addTo(self.node_page)
        self.page1 = page1
    end
    local page2 = util_createView("views.Card.CardRank202204.CardRankHelpItemUI", 2)
