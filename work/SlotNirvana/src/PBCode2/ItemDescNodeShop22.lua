...
local ItemDescNodeShop22 = class("ItemDescNodeShop22", BaseItemNode)
--初始化csb
function ItemDescNodeShop22:getCsbPath()
    return "PBRes/CommonItemRes/ItemDescNode_Shop2022.csb"
end
--更新道具
function ItemDescNodeShop22:updateLayoutValue(value)
...
--名字限制大小
function ItemDescNodeShop22:updateNameSize()
    --设置名字
    -- if self.m_lb_name then
    --     self:updateLabelSize({label = self.m_lb_name},130)
    -- end
end
return ItemDescNodeShop22