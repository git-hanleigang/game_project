...
local QuestNewSlideNode = class("QuestNewSlideNode", util_require("views.lobby.SlideNode"))

function QuestNewSlideNode:initCsbNodes()
...
function QuestNewSlideNode:onEnter()
    QuestNewSlideNode.super.onEnter(self)
    schedule(
        self,
        function()
            self:updateDiscount()
...
function QuestNewSlideNode:updateView()
    if self.m_data == nil then
        return
    end
end

function QuestNewSlideNode:updateDiscount()
