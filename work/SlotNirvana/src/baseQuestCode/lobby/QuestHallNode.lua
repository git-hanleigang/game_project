...
local QuestHallNode = class("QuestHallNode", util_require("views.lobby.HallNode"))

function QuestHallNode:initCsbNodes()
...
function QuestHallNode:updateDiscount()
...
-- 点击是否播点击音效
function QuestHallNode:isClickPlaySound()
    return true
end

return QuestHallNode
