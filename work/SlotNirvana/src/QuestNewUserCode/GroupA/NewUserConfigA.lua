...
local code_path = "QuestNewUserCode/GroupA/Quest/"
local res_path = "QuestNewUser/Activity/csd/GroupA/"
--代码路径
local ThemeConfig = {
    code = {
        ...
        QuestMainView = code_path .. "lobby/QuestNewUserMainViewA", --quest主界面
        --cell
        ...
        QuestMapConfig = "QuestNewUser/Activity/QuestNewUserMap/questMapConfigA.json" --大地图配置文件json
    },
    --资源路径
    res = {
        ...
        QuestMapBgWidth = 107,
        -- 地图配置
        BG_ROAD_LEN = 5350, -- 整个主题的长度，每个主题需要提前算好这个值
