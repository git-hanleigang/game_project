...
local MythicGameWinRewardData = class("MythicGameWinRewardData")

function MythicGameWinRewardData:parseData(data)
...
function MythicGameWinRewardData:getCoins()
    return self.p_coins or 0
end

function MythicGameWinRewardData:getGems()
    return self.p_gems or 0
end

function MythicGameWinRewardData:getItems()
    return self.p_items or {}
end

function MythicGameWinRewardData:getMergeItems()
    return self.p_items or {}
...
function MythicGameWinRewardData:hasRewards()
...
return MythicGameWinRewardData
