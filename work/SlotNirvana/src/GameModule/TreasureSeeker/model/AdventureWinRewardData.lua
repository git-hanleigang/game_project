...
local AdventureWinRewardData = class("AdventureWinRewardData")

function AdventureWinRewardData:parseData(data)
    self.p_coins = tonumber(data.coins)
    self.p_gems = data.gems
    self.p_items = {}
...
function AdventureWinRewardData:getCoins()
    return self.p_coins
end

function AdventureWinRewardData:getGems()
    return self.p_gems
end

function AdventureWinRewardData:getItems()
    return self.p_items
end

function AdventureWinRewardData:getMergeItems()
    return self.p_items
...
function AdventureWinRewardData:hasRewards()
