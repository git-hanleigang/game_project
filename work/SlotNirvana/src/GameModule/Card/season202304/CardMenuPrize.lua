...
function CardMenuPrize:initDatas()
    ...
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardPrizeRes, "season202304"))
end
...
function CardMenuPrize:getPrizeCellCsbName()
    return string.format(CardResConfig.seasonRes.CardPrizeCellRes, "season202304")
end
