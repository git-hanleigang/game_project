...
function CardAlbumTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardAlbumTitleRes, "season202304")
end

function CardAlbumTitle:getTimeLua()
    return "GameModule.Card.season202304.CardSeasonTime"
end

function CardAlbumTitle:getRoundTipLua()
    return "GameModule.Card.season202304.CardAlbumRoundTip"
end

function CardAlbumTitle:getRoundRewardListLua()
    return "GameModule.Card.season202304.CardAlbumRoundRewardList"
end
