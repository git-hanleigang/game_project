...
function CardSeasonBottom:initDatas()
    -- self.m_storeLuaPath = "GameModule.Card.season302301.CardSeasonBottomStore"
    self.m_miniGameLuaPath = "GameModule.Card.season302301.CardSeasonBottomMiniGame"
    self.m_nadoMachineLuaPath = "GameModule.Card.season302301.CardSeasonBottomNadoMachine"
    -- self.m_nadoObsidianLuaPath = "GameModule.Card.season302301.CardSeasonBottomObsidian_"
    -- self.m_nodeList = {}
end
...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season302301")
end
