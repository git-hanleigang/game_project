...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202203")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202203.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202203.CardClanTitle"
end
