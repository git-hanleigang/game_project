...
function CardSeason:ctor()
    ...
    -- 卡册界面
    self.m_cardClanUI = "GameModule.Card.season202203.CardClanView"
    -- 卡册弹框
    self.m_bigCardUI = "GameModule.Card.season202203.BigCardLayer"
    -- nado卡获得进度界面
    self.m_linkProgress = "GameModule.Card.season202203.CardLinkProgressComplete"
    -- 赛季完成界面
    self.m_albumCompleteLua = "GameModule.Card.season202203.CardAlbumComplete"
    -- 章节完成界面
    -- self.m_clanCompleteLua = "GameModule.Card.season202203.CardClanComplete"
    self.m_statueCompleteLua = "GameModule.Card.season202203.CardStatueComplete"
    ...
    self.m_roundCompleteLua = "GameModule.Card.season202203.CardRoundComplete"
end
...
function CardSeason:createCardSpecialGameBuffNode(buffMultiple)
    local statueBuffUI = util_createView("GameModule.Card.season202203.CardBuffTipNode", buffMultiple)
    return statueBuffUI
end
