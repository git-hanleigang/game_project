...
function CardAlbumTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardAlbumTitleRes, "season202203")
end

function CardAlbumTitle:getTimeLua()
    return "GameModule.Card.season202203.CardSeasonTime"
end

function CardAlbumTitle:getRoundTipLua()
    return "GameModule.Card.season202203.CardAlbumRoundTip"
end

function CardAlbumTitle:getRoundRewardListLua()
    return "GameModule.Card.season202203.CardAlbumRoundRewardList"
end
