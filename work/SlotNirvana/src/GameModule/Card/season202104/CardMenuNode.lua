...
function CardMenuNode:getCsbName()
    return string.format(CardResConfig.seasonRes.CardMenuNodeRes, "season202104")
end

-- 可重写
function CardMenuNode:getRuleLua()
    return "GameModule.Card.season202104.CardMenuRule"
end

-- 可重写
function CardMenuNode:getPrizeLua()
    return "GameModule.Card.season202104.CardMenuPrize"
end
