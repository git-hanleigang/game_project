...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202104")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202104.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202104.CardClanTitle"
end
