...
function CardSeasonStatue:getComingBubbleLua()
    return "GameModule.Card.season202104.CardSeasonStatueComing"
end

function CardSeasonStatue:getCountdownBubbleLua()
    return "GameModule.Card.season202104.CardSeasonStatueBubble"
end
...
function CardSeasonStatue:getCsbName()
    return string.format(CardResConfig.seasonRes.CardSeasonStatueRes, "season202104")
end
