...
function CardClanTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanTitleRes, "season202104")
end
...
function CardClanTitle:getQuestInfoLua()
    return "GameModule.Card.season202104.CardClanQuestInfo"
end
...
function CardClanTitle:initUI()
    ...
    -- 特效
    local efNode = util_createAnimation("CardRes/season202104/cash_clan_title_ef_bg_guang.csb")
...
function CardClanTitle:initCsbNodes()
    ...
    self.m_efBgNode = self:findChild("ef_node_bg_guang")
end
