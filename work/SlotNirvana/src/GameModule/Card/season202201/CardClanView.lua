...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202201")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202201.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202201.CardClanTitle"
end
