...
function CardMenuNode:getCsbName()
    return string.format(CardResConfig.seasonRes.CardMenuNodeRes, "season202201")
end

-- 可重写
function CardMenuNode:getRuleLua()
    return "GameModule.Card.season202201.CardMenuRule"
end

-- 可重写
function CardMenuNode:getPrizeLua()
    return "GameModule.Card.season202201.CardMenuPrize"
end
