...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202201")
end

function CardSeasonBottom:getMenuNodeLua()
    return "GameModule.Card.season202201.CardMenuNode"
end

function CardSeasonBottom:getMenuWheelLua()
    return "GameModule.Card.season202201.CardMenuWheel"
end

function CardSeasonBottom:getSeasonNadoWheelLua()
    return "GameModule.Card.season202201.CardSeasonNadoWheel"
end

--[[-- 神像入口]]
function CardSeasonBottom:getStatueLua()
    return "GameModule.Card.season202201.CardSeasonStatue"
end
...
function CardSeasonBottom:initBottomNode()
    ...
    if self.m_efNode then
        ...
        if not efNode then
            efNode = util_createAnimation("CardRes/season202201/cash_season_bottom_ef_sg.csb")
