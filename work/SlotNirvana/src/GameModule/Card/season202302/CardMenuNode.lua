...
function CardMenuNode:getCsbName()
    return string.format(CardResConfig.seasonRes.CardMenuNodeRes, "season202302")
end

-- 可重写
function CardMenuNode:getRuleLua()
    return "GameModule.Card.season202302.CardMenuRule"
end

-- 可重写
function CardMenuNode:getPrizeLua()
    return "GameModule.Card.season202302.CardMenuPrize"
end
