...
function CardSeasonBottom:initDatas()
    self.m_storeLuaPath = "GameModule.Card.season202302.CardSeasonBottomStore"
    self.m_miniGameLuaPath = "GameModule.Card.season202302.CardSeasonBottomMiniGame"
    self.m_nadoMachineLuaPath = "GameModule.Card.season202302.CardSeasonBottomNadoMachine"
    self.m_nadoObsidianLuaPath = "GameModule.Card.season202302.CardSeasonBottomObsidian_"
    self.m_nodeList = {}
end
...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202302")
end
