...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202204")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202204.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202204.CardClanTitle"
end
