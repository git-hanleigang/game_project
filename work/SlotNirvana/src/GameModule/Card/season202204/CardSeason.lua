...
function CardSeason:ctor()
    ...
    -- 卡册界面
    self.m_cardClanUI = "GameModule.Card.season202204.CardClanView"
    -- 卡册弹框
    self.m_bigCardUI = "GameModule.Card.season202204.BigCardLayer"
    -- 显示以往赛季
    self.m_collectionUI = "GameModule.Card.season202204.CardCollectionUI"
    -- nado卡获得进度界面
    self.m_linkProgress = "GameModule.Card.season202204.CardLinkProgressComplete"
    -- 赛季完成界面
    self.m_albumCompleteLua = "GameModule.Card.season202204.CardAlbumComplete"
    -- 章节完成界面
    self.m_clanCompleteLua = "GameModule.Card.season202204.CardClanComplete"
    -- self.m_statueCompleteLua = "GameModule.Card.season202204.CardStatueComplete"
    ...
    self.m_roundCompleteLua = "GameModule.Card.season202204.CardRoundComplete"
end
...
function CardSeason:createCardSpecialGameBuffNode(buffMultiple)
    local statueBuffUI = util_createView("GameModule.Card.season202204.CardBuffTipNode", buffMultiple)
    return statueBuffUI
end
