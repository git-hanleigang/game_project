...
function CardSeasonBottom:initDatas()
    self.m_storeLuaPath = "GameModule.Card.season202204.CardSeasonBottomStore"
    self.m_miniGameLuaPath = "GameModule.Card.season202204.CardSeasonBottomMiniGame"
    self.m_nadoMachineLuaPath = "GameModule.Card.season202204.CardSeasonBottomNadoMachine"
    self.m_nadoObsidianLuaPath = "GameModule.Card.season202204.CardSeasonBottomObsidian_"
    self.m_nodeList = {}
end
...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202204")
end
