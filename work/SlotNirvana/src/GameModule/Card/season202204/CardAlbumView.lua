...
function CardAlbumView:initDatas(isPlayStart)
    ...
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardAlbumViewRes, "season202204"))
    self:setName("CardAlbumView" .. "season202204")
end
...
function CardAlbumView:getTitleLuaPath()
    return "GameModule.Card.season202204.CardAlbumTitle"
end

function CardAlbumView:getBottomLuaPath()
    return "GameModule.Card.season202204.CardSeasonBottom"
end

function CardAlbumView:getCellLuaPath()
    return "GameModule.Card.season202204.CardAlbumCell"
end

function CardAlbumView:getMenuLuaPath()
    return "GameModule.Card.season202204.CardAlbumMenuLayer"
end
...
function CardAlbumView:getRoundGuideLuaPath()
    return "GameModule.Card.season202204.CardAlbumRoundGuide"
end
...
function CardAlbumView:showAlbumMenuUI()
    if gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202204") ~= nil then
        return
    end
    local view = util_createView(self:getMenuLuaPath(), handler(self, self.showMenuCloseBtn))
    view:setName("CardAlbumMenuLayer" .. "season202204")
...
function CardAlbumView:clickFunc(sender)
    ...
    elseif name == "btn_menuClose" then
        ...
        local view = gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202204")
