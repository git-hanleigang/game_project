...
function CardSeasonBottom:initDatas()
    self.m_storeLuaPath = "GameModule.Card.season202401.CardSeasonBottomStore"
    self.m_miniGameLuaPath = "GameModule.Card.season202401.CardSeasonBottomMiniGame"
    self.m_nadoMachineLuaPath = "GameModule.Card.season202401.CardSeasonBottomNadoMachine"
    self.m_nadoObsidianLuaPath = "GameModule.Card.season202401.CardSeasonBottomObsidian_"
    self.m_nodeList = {}
end
...
function CardSeasonBottom:initCsbNodes()
    ...
    -- 202401 的特殊处理 这个背景图片不知道有什么用，影响前两个背景图的显示（重叠显示），所以设置成不显示
...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202401")
end
