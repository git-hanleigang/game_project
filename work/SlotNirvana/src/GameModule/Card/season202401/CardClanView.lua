...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202401")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202401.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202401.CardClanTitle"
end
...
function CardClanView:getGuideLua()
    return "GameModule.Card.season202401.CardClanCellGuide"
end
