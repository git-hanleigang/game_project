...
function CardClanTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanTitleRes, "season202401")
end
...
function CardClanTitle:getQuestInfoLua()
    return "GameModule.Card.season202401.CardClanQuestInfo"
end
...
function CardClanTitle:updateCoin()
    ...
    if isCompleted then
        ...
        lb_coins:setString(util_formatCoins(tonumber(clanCoins), 12)) -- 2024.01 金币超框
