...
function CardAlbumView:initDatas(isPlayStart)
    ...
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardAlbumViewRes, "season202301"))
    self:setName("CardAlbumView" .. "season202301")
end
...
function CardAlbumView:getTitleLuaPath()
    return "GameModule.Card.season202301.CardAlbumTitle"
end

function CardAlbumView:getBottomLuaPath()
    return "GameModule.Card.season202301.CardSeasonBottom"
end

function CardAlbumView:getCellLuaPath()
    return "GameModule.Card.season202301.CardAlbumCell"
end

function CardAlbumView:getMenuLuaPath()
    return "GameModule.Card.season202301.CardAlbumMenuLayer"
end
...
function CardAlbumView:getRoundGuideLuaPath()
    return "GameModule.Card.season202301.CardAlbumRoundGuide"
end
...
function CardAlbumView:showAlbumMenuUI()
    if gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202301") ~= nil then
        return
    end
    local view = util_createView(self:getMenuLuaPath(), handler(self, self.showMenuCloseBtn))
    view:setName("CardAlbumMenuLayer" .. "season202301")
...
function CardAlbumView:clickFunc(sender)
    ...
    elseif name == "btn_menuClose" then
        ...
        local view = gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202301")
