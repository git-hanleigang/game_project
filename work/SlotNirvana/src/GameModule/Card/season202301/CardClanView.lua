...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202301")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202301.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202301.CardClanTitle"
end
