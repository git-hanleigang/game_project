...
--     return util_createView("GameModule.Card.season201901.CardSeasonView")
-- end

-- 显示卡组面板
function CardSeason:showCardClanView(index, enterFromAlbum)
    return util_createView("GameModule.Card.season201901.CardClanView", index, enterFromAlbum)
end

-- 显示大卡面板
function CardSeason:showBigCardView(clanIndex, cardIndex)
    return util_createView("GameModule.Card.season201901.BigCardLayer", clanIndex, cardIndex)
end
