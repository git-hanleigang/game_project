...
function CardSeasonStatue:getComingBubbleLua()
    return "GameModule.Card.season202202.CardSeasonStatueComing"
end

function CardSeasonStatue:getCountdownBubbleLua()
    return "GameModule.Card.season202202.CardSeasonStatueBubble"
end
...
function CardSeasonStatue:getCsbName()
    return string.format(CardResConfig.seasonRes.CardSeasonStatueRes, "season202202")
end
