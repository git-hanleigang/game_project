...
function CardClanTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanTitleRes, "season202202")
end
...
function CardClanTitle:getQuestInfoLua()
    return "GameModule.Card.season202202.CardClanQuestInfo"
end
...
function CardClanTitle:updateCoin()
    ...
    if isCompleted then
        ...
        local coins = tonumber(self.m_clanData.coins)
        ...
        lb_coins:setString(util_formatCoins(coins * specialReward, 30))
