...
--     return string.format(CardResConfig.seasonRes.CardPrizeRes, "season201904")
-- end

function CardMenuPrize:initDatas()
    CardMenuPrize.super.initDatas(self)
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardPrizeRes, "season201904"))
end
...
function CardMenuPrize:getPrizeCellCsbName()
    return string.format(CardResConfig.seasonRes.CardPrizeCellRes, "season201904")
end
