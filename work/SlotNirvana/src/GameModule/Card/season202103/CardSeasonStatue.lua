...
function CardSeasonStatue:getComingBubbleLua()
    return "GameModule.Card.season202103.CardSeasonStatueComing"
end

function CardSeasonStatue:getCountdownBubbleLua()
    return "GameModule.Card.season202103.CardSeasonStatueBubble"
end
...
function CardSeasonStatue:getCsbName()
    return string.format(CardResConfig.seasonRes.CardSeasonStatueRes, "season202103")
end
