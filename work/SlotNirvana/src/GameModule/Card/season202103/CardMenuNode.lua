...
function CardMenuNode:getCsbName()
    return string.format(CardResConfig.seasonRes.CardMenuNodeRes, "season202103")
end

-- 可重写
function CardMenuNode:getRuleLua()
    return "GameModule.Card.season202103.CardMenuRule"
end

-- 可重写
function CardMenuNode:getPrizeLua()
    return "GameModule.Card.season202103.CardMenuPrize"
end
