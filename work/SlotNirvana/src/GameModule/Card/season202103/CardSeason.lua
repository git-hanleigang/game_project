...
function CardSeason:ctor()
    ...
    -- 卡册界面
    self.m_cardClanUI = "GameModule.Card.season202103.CardClanView"
    -- 卡册弹框
    self.m_bigCardUI = "GameModule.Card.season202103.BigCardLayer"
    -- nado卡获得进度界面
    self.m_linkProgress = "GameModule.Card.season202103.CardLinkProgressComplete"
    -- 章节完成界面
    -- self.m_clanCompleteLua = "GameModule.Card.season202103.CardClanComplete"
    self.m_statueCompleteLua = "GameModule.Card.season202103.CardStatueComplete"
...
function CardSeason:createCardSpecialGameBuffNode(buffMultiple)
    local statueBuffUI = util_createView("GameModule.Card.season202103.CardBuffTipNode", buffMultiple)
    return statueBuffUI
end
