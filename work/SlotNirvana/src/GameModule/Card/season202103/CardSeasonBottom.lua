...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202103")
end

function CardSeasonBottom:getMenuNodeLua()
    return "GameModule.Card.season202103.CardMenuNode"    
end

function CardSeasonBottom:getMenuWheelLua()
    return "GameModule.Card.season202103.CardMenuWheel"    
end

function CardSeasonBottom:getSeasonNadoWheelLua()
    return "GameModule.Card.season202103.CardSeasonNadoWheel"    
end

--[[-- 神像入口]]
function CardSeasonBottom:getStatueLua()
    return "GameModule.Card.season202103.CardSeasonStatue"
end
