...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202103")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202103.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202103.CardClanTitle"
end
