...
function CardClanTitle:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanTitleRes, "season202103")
end
...
function CardClanTitle:getQuestInfoLua()
    return "GameModule.Card.season202103.CardClanQuestInfo"
end
...
function CardClanTitle:initStatueBuffNode()
    ...
    if nMuti and nMuti > 0 then
        -- local statueBuffUI = util_createView("GameModule.Card.season202103.CardBuffTipNode", nMuti)
