...
--     return string.format(CardResConfig.seasonRes.CardAlbumViewRes, "season202102")
-- end

function CardAlbumView:initDatas(isPlayStart)
    CardAlbumView.super.initDatas(self, isPlayStart)
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardAlbumViewRes, "season202102"))
end

function CardAlbumView:getTitleLuaPath()
    return "GameModule.Card.season202102.CardAlbumTitle"
end

function CardAlbumView:getBottomLuaPath()
    return "GameModule.Card.season202102.CardSeasonBottom"
end

function CardAlbumView:getCellLuaPath()
    return "GameModule.Card.season202102.CardAlbumCell"
end
