...
function CardSeasonStatue:getComingBubbleLua()
    return "GameModule.Card.season202102.CardSeasonStatueComing"
end

function CardSeasonStatue:getCountdownBubbleLua()
    return "GameModule.Card.season202102.CardSeasonStatueBubble"
end
...
function CardSeasonStatue:getCsbName()
    return string.format(CardResConfig.seasonRes.CardSeasonStatueRes, "season202102")
end
