...
function CardMenuNode:getCsbName()
    return string.format(CardResConfig.seasonRes.CardMenuNodeRes, "season202102")
end

-- 可重写
function CardMenuNode:getRuleLua()
    return "GameModule.Card.season202102.CardMenuRule"
end

-- 可重写
function CardMenuNode:getPrizeLua()
    return "GameModule.Card.season202102.CardMenuPrize"
end
