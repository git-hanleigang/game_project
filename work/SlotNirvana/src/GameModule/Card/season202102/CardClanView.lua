...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202102")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202102.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202102.CardClanTitle"
end
