...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202303")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202303.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202303.CardClanTitle"
end
...
function CardClanView:getGuideLua()
    return "GameModule.Card.season202303.CardClanCellGuide"
end
