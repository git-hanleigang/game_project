...
function CardSeasonBottom:initDatas()
    self.m_storeLuaPath = "GameModule.Card.season202303.CardSeasonBottomStore"
    self.m_miniGameLuaPath = "GameModule.Card.season202303.CardSeasonBottomMiniGame"
    self.m_nadoMachineLuaPath = "GameModule.Card.season202303.CardSeasonBottomNadoMachine"
    self.m_nadoObsidianLuaPath = "GameModule.Card.season202303.CardSeasonBottomObsidian_"
    self.m_nodeList = {}
end
...
function CardSeasonBottom:getCsbName()
    return string.format(CardResConfig.seasonRes.CardBottomNodeRes, "season202303")
end
