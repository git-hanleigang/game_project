...
function CardAlbumView:initDatas(isPlayStart)
    ...
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardAlbumViewRes, "season202303"))
    self:setName("CardAlbumView" .. "season202303")
end
...
function CardAlbumView:getTitleLuaPath()
    return "GameModule.Card.season202303.CardAlbumTitle"
end

function CardAlbumView:getBottomLuaPath()
    return "GameModule.Card.season202303.CardSeasonBottom"
end

function CardAlbumView:getCellLuaPath()
    return "GameModule.Card.season202303.CardAlbumCell"
end

function CardAlbumView:getMenuLuaPath()
    return "GameModule.Card.season202303.CardAlbumMenuLayer"
end
...
function CardAlbumView:getRoundGuideLuaPath()
    return "GameModule.Card.season202303.CardAlbumRoundGuide"
end
...
function CardAlbumView:showAlbumMenuUI()
    if gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202303") ~= nil then
        return
    end
    local view = util_createView(self:getMenuLuaPath(), handler(self, self.showMenuCloseBtn))
    view:setName("CardAlbumMenuLayer" .. "season202303")
...
function CardAlbumView:clickFunc(sender)
    ...
    elseif name == "btn_menuClose" then
        ...
        local view = gLobalViewManager:getViewByName("CardAlbumMenuLayer" .. "season202303")
...
function CardAlbumView:getGuideLua()
    return "GameModule.Card.season202303.CardAlbumCellGuide"
end
