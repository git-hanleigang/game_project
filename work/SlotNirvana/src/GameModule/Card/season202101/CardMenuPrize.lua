...
--     return string.format(CardResConfig.seasonRes.CardPrizeRes, "season202101")
-- end

function CardMenuPrize:initDatas()
    CardMenuPrize.super.initDatas(self)
    self:setLandscapeCsbName(string.format(CardResConfig.seasonRes.CardPrizeRes, "season202101"))
end
...
function CardMenuPrize:getPrizeCellCsbName()
    return string.format(CardResConfig.seasonRes.CardPrizeCellRes, "season202101")
end
