...
function CardClanView:getCsbName()
    return string.format(CardResConfig.seasonRes.CardClanViewRes, "season202101")
end

function CardClanView:getCellLua()
    return "GameModule.Card.season202101.CardClanCell"
end

function CardClanView:getTitleLua()
    return "GameModule.Card.season202101.CardClanTitle"
end
