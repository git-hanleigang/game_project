...
local LuckySpinSlotNodeV2 = class("LuckySpinSlotNodeV2",SlotsNode)

LuckySpinSlotNodeV2.p_levelPushAnimNodeCallFun = nil
LuckySpinSlotNodeV2.p_levelGetAnimNodeCallFun = nil

function LuckySpinSlotNodeV2:removeAndPushCcbToPool()
...
function LuckySpinSlotNodeV2:initSlotNodeByCCBName(ccbName,symbolType)
    --    if ccbName == nil then
...
---
-- 还原到初始被创建的状态
function LuckySpinSlotNodeV2:reset()
...
function LuckySpinSlotNodeV2:clear()
...
function LuckySpinSlotNodeV2:checkLoadCCbNode()
