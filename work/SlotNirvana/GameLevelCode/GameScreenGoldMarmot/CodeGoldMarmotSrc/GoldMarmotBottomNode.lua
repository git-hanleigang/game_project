...
--xcyy
--2018年5月23日
--GoldMarmotBottomNode.lua

local GoldMarmotBottomNode = class("GoldMarmotBottomNode", util_require("views.gameviews.GameBottomNode"))

function GoldMarmotBottomNode:createCoinWinEffectUI()
...
-- 修改已创建的收集反馈效果
function GoldMarmotBottomNode:changeCoinWinEffectUI(_levelName, _csbName)
...
function GoldMarmotBottomNode:playCoinWinEffectUI(callBack)
