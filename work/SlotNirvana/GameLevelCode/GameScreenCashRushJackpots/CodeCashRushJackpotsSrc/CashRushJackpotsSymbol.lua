local CashRushJackpotsSymbol = class("CashRushJackpotsSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function CashRushJackpotsSymbol:ctor()
    CashRushJackpotsSymbol.super.ctor(self)
...
function CashRushJackpotsSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function CashRushJackpotsSymbol:changeSymbolCcb(_symbolType)
...
function CashRushJackpotsSymbol:createAnimNode()
...
function CashRushJackpotsSymbol:upDateAnimNode()
...
function CashRushJackpotsSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function CashRushJackpotsSymbol:getNodeSpine()
    return self.m_animNode
end

function CashRushJackpotsSymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function CashRushJackpotsSymbol:getAnimDurationTime(animName)
