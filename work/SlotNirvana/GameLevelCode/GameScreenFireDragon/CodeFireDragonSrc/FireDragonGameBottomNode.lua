...
--
local FireDragonGameBottomNode = class("FireDragonGameBottomNode", util_require("views.gameviews.GameBottomNode"))
...
--
function FireDragonGameBottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim)
...
return  FireDragonGameBottomNode