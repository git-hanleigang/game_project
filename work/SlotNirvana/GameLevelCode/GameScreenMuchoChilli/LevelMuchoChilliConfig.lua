...
local LevelMuchoChilliConfig = class("LevelMuchoChilliConfig", LevelConfigData)

LevelMuchoChilliConfig.m_bnBasePro1 = nil
LevelMuchoChilliConfig.m_bnBaseTotalWeight1 = nil


function LevelMuchoChilliConfig:parsePro( value )
...
function LevelMuchoChilliConfig:parseSelfConfigData(colKey, colValue)
...
function LevelMuchoChilliConfig:getFixSymbolPro( )
...
function LevelMuchoChilliConfig:getValueByPros( proValues , totalWeight )
