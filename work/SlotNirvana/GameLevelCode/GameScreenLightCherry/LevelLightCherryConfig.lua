...
local LevelLightCherryConfig = class("LevelLightCherryConfig", LevelConfigData)

LevelLightCherryConfig.m_bnBasePro1 = nil
LevelLightCherryConfig.m_bnBaseTotalWeight1 = nil


function LevelLightCherryConfig:parsePro( value )
...
function LevelLightCherryConfig:parseSelfConfigData(colKey, colValue)
...
function LevelLightCherryConfig:getFixSymbolPro( )
...
function LevelLightCherryConfig:getValueByPros( proValues , totalWeight )
