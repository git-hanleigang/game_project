...
--xcyy
--2018年5月23日
--HallowinBottomNode.lua

local HallowinBottomNode = class("HallowinBottomNode", util_require("views.gameviews.GameBottomNode"))

function HallowinBottomNode:createCoinWinEffectUI()
...
-- 修改已创建的收集反馈效果
function HallowinBottomNode:changeCoinWinEffectUI(_levelName, _csbName)
...
function HallowinBottomNode:playCoinWinEffectUI(callBack)
