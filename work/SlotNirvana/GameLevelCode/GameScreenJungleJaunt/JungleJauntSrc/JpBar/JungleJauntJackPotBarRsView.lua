...
--xcyy
--2018年5月23日
--JungleJauntJackPotBarRsView.lua
local PBC = require "JungleJauntPublicConfig"
local JungleJauntJackPotBarRsView = class("JungleJauntJackPotBarRsView", util_require("base.BaseView"))
...
function JungleJauntJackPotBarRsView:initUI()
    self:createCsbNode("JungleJaunt_respin_jackpot.csb")
...
function JungleJauntJackPotBarRsView:initMachine(machine)
    self.m_machine = machine
end

function JungleJauntJackPotBarRsView:addObservers()
...
function JungleJauntJackPotBarRsView:onEnter()
...
-- 更新jackpot 数值信息
--
function JungleJauntJackPotBarRsView:updateJackpotInfo()
...
function JungleJauntJackPotBarRsView:updateSize()
...
function JungleJauntJackPotBarRsView:changeNode(label, index, isJump)
    local value = self.m_machine:BaseMania_updateJackpotScore(index)
    label:setString(util_formatCoinsLN(value, 12, nil, nil, true))
end

return JungleJauntJackPotBarRsView
