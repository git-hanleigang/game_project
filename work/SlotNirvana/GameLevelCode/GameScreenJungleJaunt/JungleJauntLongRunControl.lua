...
local JungleJauntLongRunControl = class("JungleJauntLongRunControl")

function JungleJauntLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function JungleJauntLongRunControl:getUsingReels()
    return self.usingReels
end

function JungleJauntLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function JungleJauntLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function JungleJauntLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function JungleJauntLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function JungleJauntLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function JungleJauntLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function JungleJauntLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function JungleJauntLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function JungleJauntLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function JungleJauntLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function JungleJauntLongRunControl:setLongRunLenAndStates()
...
function JungleJauntLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function JungleJauntLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function JungleJauntLongRunControl:clearCurLongRunData()
...
function JungleJauntLongRunControl:setFirstColBeginLongRun()
...
return JungleJauntLongRunControl
