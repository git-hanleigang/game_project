...
--版权所有:{company}
-- Author:{author}
-- Date: 2020-07-08 12:17:50
--

local LevelConfigData = require("data.slotsdata.LevelConfigData")
local LevelGoldenPigConfig = class("LevelGoldenPigConfig", LevelConfigData)

function LevelGoldenPigConfig:ctor()
      LevelConfigData.ctor(self)
end


function LevelGoldenPigConfig:parseSelfConfigData(colKey, colValue)
...
function LevelGoldenPigConfig:getPigShapePro(area)
      if area == 4 then
  ...
  -- 金块滚动数据
function LevelGoldenPigConfig:getPigShapeShow(area)
      if area == 4 then
