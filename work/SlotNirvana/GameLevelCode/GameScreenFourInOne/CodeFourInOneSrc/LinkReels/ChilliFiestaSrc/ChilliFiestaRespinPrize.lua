...
function ChilliFiestaRespinPrize:initUI(data)
    ...
    local resourceFilename = "LinkReels/ChilliFiestaLink/4in1_ChilliFiesta_Respin_Prize.csb"
...
function ChilliFiestaRespinPrize:playCollect()
     gLobalSoundManager:playSound("FourInOneSounds/ChilliFiestaSounds/music_ChilliFiesta_bonusCollectBuling.mp3")
