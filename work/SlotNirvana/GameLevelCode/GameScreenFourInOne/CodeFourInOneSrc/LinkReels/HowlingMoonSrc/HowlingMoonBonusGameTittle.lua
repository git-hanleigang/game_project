...
function HowlingMoonBonusGameTittle:initUI(data)
    ...
    local resourceFilename="LinkReels/HowlingMoonLink/4in1_Socre_HowlingMoon_FreeGame.csb"
...
function HowlingMoonBonusGameTittle:updataRespinTimes( curtimes ,isfirst)
    if curtimes == 3  then
        if not isfirst then
            gLobalSoundManager:playSound("FourInOneSounds/HowlingMoonSounds/music_HowlingMoon_spin_respin_to3.mp3")
        end
        self:toAction(false)
