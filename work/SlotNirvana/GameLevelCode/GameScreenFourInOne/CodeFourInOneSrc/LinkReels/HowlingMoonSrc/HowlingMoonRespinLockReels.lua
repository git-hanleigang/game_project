...
function HowlingMoonRespinLockReels:initUI(data)
    ...
    local resourceFilename="LinkReels/HowlingMoonLink/4in1_Socre_HowlingMoon_Lock.csb"
...
function HowlingMoonRespinLockReels:unLockAction( isloop,func )
    ...
    function()   
        gLobalSoundManager:playSound("FourInOneSounds/HowlingMoonSounds/sound_HowlingMoon_unlock.mp3")
