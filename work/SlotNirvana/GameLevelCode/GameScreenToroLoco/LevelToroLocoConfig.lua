...
local LevelToroLocoConfig = class("LevelToroLocoConfig", LevelConfigData)

LevelToroLocoConfig.m_bnBasePro1 = nil
LevelToroLocoConfig.m_bnBaseTotalWeight1 = nil


function LevelToroLocoConfig:parsePro( value )
...
function LevelToroLocoConfig:parseSelfConfigData(colKey, colValue)
...
function LevelToroLocoConfig:getFixSymbolPro( )
...
function LevelToroLocoConfig:getValueByPros( proValues , totalWeight )
