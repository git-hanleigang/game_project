...
local JollyFactoryLongRunControl = class("JollyFactoryLongRunControl")
...
function JollyFactoryLongRunControl:initData_(params)
...
function JollyFactoryLongRunControl:checkTriggerLongRun(lockNodesInfo)
    self.longRunStatus = {}
    --预告中奖时不触发快滚
...
function JollyFactoryLongRunControl:checkLongRunBySymbolType(triggerCfg,lockNodesInfo)
...
function JollyFactoryLongRunControl:setLongRunInfo(colIndex)
    --已经是快滚状态的列不需要再次设置
...
function JollyFactoryLongRunControl:setFirstColBeginLongRun()
...
return JollyFactoryLongRunControl
