...
--xcyy
--2018年5月23日
--JollyFactorySkipBtn.lua
local JollyFactorySkipBtn = class("JollyFactorySkipBtn",util_require("base.BaseView"))

function JollyFactorySkipBtn:initUI(params)
...
function JollyFactorySkipBtn:onEnter()
    JollyFactorySkipBtn.super.onEnter(self)
...
function JollyFactorySkipBtn:createClickLayer()
    --压黑层
...
--默认按钮监听回调
function JollyFactorySkipBtn:clickFunc(sender)
    self.m_machine:skipFunc()
end

return JollyFactorySkipBtn