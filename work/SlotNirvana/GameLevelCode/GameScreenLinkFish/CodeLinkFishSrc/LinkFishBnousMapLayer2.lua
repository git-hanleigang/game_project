...
local LinkFishBnousMapLayer2 = class("LinkFishBnousMapLayer2", BaseScroll)

LinkFishBnousMapLayer2.AUTO_STOP_SPEED = 1    -- 惯性滑动停止速度
LinkFishBnousMapLayer2.AUTO_IN_MOVE = 10      -- 手势滑动开启平均值
LinkFishBnousMapLayer2.AUTO_FRICTIONE = 0.8  -- 摩擦力
LinkFishBnousMapLayer2.AUTO_MAX_SPEED = 40   -- 速度峰值
LinkFishBnousMapLayer2.DELTA_SPEED = 0.3    -- 惯性初速度系数

LinkFishBnousMapLayer2.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function LinkFishBnousMapLayer2:initContent(node)
    self.m_content = node
...
function LinkFishBnousMapLayer2:touchMoveLogic(touch, event)
...
function LinkFishBnousMapLayer2:setParent(parent)
    self.m_parent = parent
end

return LinkFishBnousMapLayer2