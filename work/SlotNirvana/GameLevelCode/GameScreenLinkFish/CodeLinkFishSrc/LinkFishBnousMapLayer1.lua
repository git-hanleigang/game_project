...
local LinkFishBnousMapLayer1 = class("LinkFishBnousMapLayer1", BaseScroll)

LinkFishBnousMapLayer1.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function LinkFishBnousMapLayer1:initContent(node)
    self.m_content = node
...
function LinkFishBnousMapLayer1:move(x)
...
function LinkFishBnousMapLayer1:setParent(parent)
    self.m_parent = parent
end

return LinkFishBnousMapLayer1