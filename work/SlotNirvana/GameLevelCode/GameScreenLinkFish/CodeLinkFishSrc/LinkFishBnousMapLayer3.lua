...
local LinkFishBnousMapLayer3 = class("LinkFishBnousMapLayer3", BaseScroll)
-- 构造函数
LinkFishBnousMapLayer3.AUTO_STOP_SPEED = 0.5    -- 惯性滑动停止速度
LinkFishBnousMapLayer3.AUTO_IN_MOVE = 5      -- 手势滑动开启平均值
LinkFishBnousMapLayer3.AUTO_FRICTIONE = 0.9  -- 摩擦力
LinkFishBnousMapLayer3.AUTO_MAX_SPEED = 20   -- 速度峰值
LinkFishBnousMapLayer3.DELTA_SPEED = 0.1    -- 惯性初速度系数

LinkFishBnousMapLayer3.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function LinkFishBnousMapLayer3:initContent(node)
    self.m_content = node
...
function LinkFishBnousMapLayer3:touchMoveLogic(touch, event)
...
function LinkFishBnousMapLayer3:setParent(parent)
    self.m_parent = parent
end

return LinkFishBnousMapLayer3