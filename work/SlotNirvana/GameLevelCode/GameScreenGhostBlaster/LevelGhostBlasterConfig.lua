...
local LevelGhostBlasterConfig = class("LevelGhostBlasterConfig", LevelConfigData)

LevelGhostBlasterConfig.m_bnBasePro1 = nil
LevelGhostBlasterConfig.m_bnBaseTotalWeight1 = nil


function LevelGhostBlasterConfig:parsePro( value )
...
function LevelGhostBlasterConfig:parseSelfConfigData(colKey, colValue)
...
function LevelGhostBlasterConfig:getFixSymbolPro( )
...
function LevelGhostBlasterConfig:getValueByPros( proValues , totalWeight )
...
return  LevelGhostBlasterConfig