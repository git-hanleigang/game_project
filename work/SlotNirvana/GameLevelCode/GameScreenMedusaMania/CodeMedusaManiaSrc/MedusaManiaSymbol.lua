local MedusaManiaSymbol = class("MedusaManiaSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function MedusaManiaSymbol:ctor()
    MedusaManiaSymbol.super.ctor(self)
...
function MedusaManiaSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function MedusaManiaSymbol:changeSymbolCcb(_symbolType)
...
function MedusaManiaSymbol:createAnimNode()
...
function MedusaManiaSymbol:upDateAnimNode()
...
function MedusaManiaSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function MedusaManiaSymbol:getNodeSpine()
...
-- 获取动画持续时间
--
function MedusaManiaSymbol:getAnimDurationTime(animName)
