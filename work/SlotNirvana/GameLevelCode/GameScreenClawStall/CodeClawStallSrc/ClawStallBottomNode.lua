...
--xcyy
--2018年5月23日
--ClawStallBottomNode.lua

local ClawStallBottomNode = class("ClawStallBottomNode",util_require("views.gameviews.GameBottomNode"))

--获取当前Bet序号
function ClawStallBottomNode:getBetIndexById(betId)
...
function ClawStallBottomNode:changeBetCoinNumToHight()
...
function ClawStallBottomNode:changeBetCoinNumToLow()
