...
local LevelClawStallConfig = class("LevelClawStallConfig", LevelConfigData)

LevelClawStallConfig.m_bnBasePro1 = nil
LevelClawStallConfig.m_bnBaseTotalWeight1 = nil

function LevelClawStallConfig:parseSelfConfigData(colKey, colValue)
...
function LevelClawStallConfig:getBnBasePro()
...
function LevelClawStallConfig:getValueByPros( proValues , totalWeight )
