...
local LevelTheHonorOfZorroConfig = class("LevelTheHonorOfZorroConfig", LevelConfigData)

LevelTheHonorOfZorroConfig.m_bnBasePro1 = nil
LevelTheHonorOfZorroConfig.m_bnBaseTotalWeight1 = nil


function LevelTheHonorOfZorroConfig:parsePro( value )
...
function LevelTheHonorOfZorroConfig:parseSelfConfigData(colKey, colValue)
...
function LevelTheHonorOfZorroConfig:getFixSymbolPro( )
...
function LevelTheHonorOfZorroConfig:getValueByPros( proValues , totalWeight )
...
return  LevelTheHonorOfZorroConfig