...
local LevelAquaQuestConfig = class("LevelAquaQuestConfig", LevelConfigData)

LevelAquaQuestConfig.m_bnBasePro1 = nil
LevelAquaQuestConfig.m_bnBaseTotalWeight1 = nil


function LevelAquaQuestConfig:parsePro( value )
...
function LevelAquaQuestConfig:CsvDataRule_ParseSelfData(colKey, colValue)
...
function LevelAquaQuestConfig:getFixSymbolPro( )
...
function LevelAquaQuestConfig:getValueByPros( proValues , totalWeight )
