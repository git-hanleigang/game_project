...
local AquaQuestLongRunControl = class("AquaQuestLongRunControl")
...
function AquaQuestLongRunControl:initData_(params)
...
function AquaQuestLongRunControl:checkTriggerLongRun(lockNodesInfo)
    self.longRunStatus = {}
    --预告中奖时不触发快滚
...
function AquaQuestLongRunControl:checkLongRunBySymbolType(triggerCfg,lockNodesInfo)
...
function AquaQuestLongRunControl:setLongRunInfo(colIndex)
    --已经是快滚状态的列不需要再次设置
...
function AquaQuestLongRunControl:setFirstColBeginLongRun()
...
return AquaQuestLongRunControl
