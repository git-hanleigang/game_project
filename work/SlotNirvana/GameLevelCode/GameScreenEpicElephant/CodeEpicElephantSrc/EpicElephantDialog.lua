...
local EpicElephantDialog = class("EpicElephantDialog",util_require("Levels.BaseDialog"))

EpicElephantDialog.m_tanbanOverSound = nil

function EpicElephantDialog:clickFunc(sender)
