...
--xcyy
--2018年5月23日
--OrcaCaptainGrandJackpotWinView.lua
local PublicConfig = require "OrcaCaptainPublicConfig"
local OrcaCaptainGrandJackpotWinView = class("OrcaCaptainGrandJackpotWinView",util_require("Levels.BaseLevelDialog"))
...
function OrcaCaptainGrandJackpotWinView:initUI(params)
    --jackpot类型统一转化为小写
    ...
    self:createCsbNode("OrcaCaptain/JackpotWinView_grand.csb")
...
function OrcaCaptainGrandJackpotWinView:showView(winCoin)
    gLobalSoundManager:playSound(PublicConfig.SoundConfig.sound_OrcaCaptain_color_jp_grand)
...
function OrcaCaptainGrandJackpotWinView:showOver()
...
function OrcaCaptainGrandJackpotWinView:jumpCoins(params)
...
function OrcaCaptainGrandJackpotWinView:clickFunc(sender)
...
function OrcaCaptainGrandJackpotWinView:createGrandShare()
...
function OrcaCaptainGrandJackpotWinView:jumpCoinsFinish()
...
function OrcaCaptainGrandJackpotWinView:checkShareState()
    local bShare = false
    if nil ~= self.m_grandShare then
...
function OrcaCaptainGrandJackpotWinView:jackpotViewOver(_fun)
    if nil ~= self.m_grandShare then
...
return OrcaCaptainGrandJackpotWinView