...
local CloverHatBonusMapLayer1 = class("CloverHatBonusMapLayer1", BaseScroll)

CloverHatBonusMapLayer1.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function CloverHatBonusMapLayer1:initContent(node)
    self.m_content = node
...
function CloverHatBonusMapLayer1:setMoveFunc( _func )
    self.m_moveFunc = _func
end

function CloverHatBonusMapLayer1:move(x)
...
function CloverHatBonusMapLayer1:setParent(parent)
    self.m_parent = parent
end

return CloverHatBonusMapLayer1