...
local CloverHatBonusMapLayer3 = class("CloverHatBonusMapLayer3", BaseScroll)
-- 构造函数
CloverHatBonusMapLayer3.AUTO_STOP_SPEED = 0.5    -- 惯性滑动停止速度
CloverHatBonusMapLayer3.AUTO_IN_MOVE = 5      -- 手势滑动开启平均值
CloverHatBonusMapLayer3.AUTO_FRICTIONE = 0.9  -- 摩擦力
CloverHatBonusMapLayer3.AUTO_MAX_SPEED = 20   -- 速度峰值
CloverHatBonusMapLayer3.DELTA_SPEED = 0.1    -- 惯性初速度系数

CloverHatBonusMapLayer3.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function CloverHatBonusMapLayer3:initContent(node)
    self.m_content = node
...
function CloverHatBonusMapLayer3:touchMoveLogic(touch, event)
...
function CloverHatBonusMapLayer3:setParent(parent)
    self.m_parent = parent
end

return CloverHatBonusMapLayer3