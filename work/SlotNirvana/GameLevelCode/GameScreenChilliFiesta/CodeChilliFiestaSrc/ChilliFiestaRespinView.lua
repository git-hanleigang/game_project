...
ChilliFiestaRespinView.SYMBOL_FIX_GRAND = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 13
ChilliFiestaRespinView.SYMBOL_FIX_MAJOR = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 12
ChilliFiestaRespinView.SYMBOL_FIX_MINOR = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 11
ChilliFiestaRespinView.SYMBOL_FIX_MINI = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 10
ChilliFiestaRespinView.SYMBOL_FIX_SYMBOL = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 1
ChilliFiestaRespinView.SYMBOL_FIX_SCORE10 = TAG_SYMBOL_TYPE.SYMBOL_SCORE_1 + 1
ChilliFiestaRespinView.SYMBOL_FIX_ALL = TAG_SYMBOL_TYPE.SYMBOL_INVALID_TYPE + 14
...
function ChilliFiestaRespinView:runNodeEnd(endNode)
      if endNode and (endNode.p_symbolType == self.SYMBOL_FIX_SYMBOL
       or endNode.p_symbolType == self.SYMBOL_FIX_MINI
        or endNode.p_symbolType == self.SYMBOL_FIX_MINOR
         or endNode.p_symbolType == self.SYMBOL_FIX_MAJOR
          or endNode.p_symbolType == self.SYMBOL_FIX_GRAND
            or endNode.p_symbolType == self.SYMBOL_FIX_ALL)
          then
            if endNode.p_symbolType ~= self.SYMBOL_FIX_ALL then

                  gLobalSoundManager:playSound("ChilliFiestaSounds/music_ChilliFiesta_baseBonusBuling.mp3")
            else
                  gLobalSoundManager:playSound("ChilliFiestaSounds/music_ChilliFiesta_GoldBonusBuling.mp3")
            end
...
function ChilliFiestaRespinView:oneReelDown()
      -- body
      gLobalSoundManager:playSound("ChilliFiestaSounds/music_ChilliFiesta_reelStop.mp3")
