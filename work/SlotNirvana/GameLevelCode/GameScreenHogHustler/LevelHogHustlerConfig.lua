...
local LevelHogHustlerConfig = class("LevelHogHustlerConfig", LevelConfigData)

LevelHogHustlerConfig.m_bnBasePro1 = nil
LevelHogHustlerConfig.m_bnBaseTotalWeight1 = nil


function LevelHogHustlerConfig:parsePro( value )
...
-- function LevelHogHustlerConfig:CsvDataRule_ParseSelfData(colKey, colValue)
...
function LevelHogHustlerConfig:parseSelfConfigData(colKey, colValue)
...
function LevelHogHustlerConfig:getFixSymbolPro( )
...
function LevelHogHustlerConfig:getValueByPros( proValues , totalWeight )
