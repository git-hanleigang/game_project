...
local LevelBingoldKoiConfig = class("LevelBingoldKoiConfig", LevelConfigData)

LevelBingoldKoiConfig.m_bnBasePro1 = nil
LevelBingoldKoiConfig.m_bnBaseTotalWeight1 = nil

function LevelBingoldKoiConfig:parseSelfConfigData(colKey, colValue)
...
function LevelBingoldKoiConfig:getBnBasePro()
...
function LevelBingoldKoiConfig:getValueByPros( proValues , totalWeight )
