local BingoldKoiSymbol = class("BingoldKoiSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function BingoldKoiSymbol:ctor()
    BingoldKoiSymbol.super.ctor(self)
...
function BingoldKoiSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function BingoldKoiSymbol:changeSymbolCcb(_symbolType)
...
function BingoldKoiSymbol:createAnimNode()
...
function BingoldKoiSymbol:upDateAnimNode()
...
function BingoldKoiSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function BingoldKoiSymbol:getNodeSpine()
...
-- 获取动画持续时间
--
function BingoldKoiSymbol:getAnimDurationTime(animName)
