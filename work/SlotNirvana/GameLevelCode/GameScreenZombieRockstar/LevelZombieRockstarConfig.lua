...
local LevelZombieRockstarConfig = class("LevelZombieRockstarConfig", LevelConfigData)

LevelZombieRockstarConfig.m_bnBasePro1 = nil
LevelZombieRockstarConfig.m_bnBaseTotalWeight1 = nil


function LevelZombieRockstarConfig:parsePro( value )
...
function LevelZombieRockstarConfig:CsvDataRule_ParseSelfData(colKey, colValue)
...
function LevelZombieRockstarConfig:getFixSymbolPro( )
...
function LevelZombieRockstarConfig:getValueByPros( proValues , totalWeight )
...
return  LevelZombieRockstarConfig