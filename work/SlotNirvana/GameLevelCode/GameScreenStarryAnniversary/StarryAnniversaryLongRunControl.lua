...
local StarryAnniversaryLongRunControl = class("StarryAnniversaryLongRunControl")

function StarryAnniversaryLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function StarryAnniversaryLongRunControl:getUsingReels()
    return self.usingReels
end

function StarryAnniversaryLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function StarryAnniversaryLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function StarryAnniversaryLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function StarryAnniversaryLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function StarryAnniversaryLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function StarryAnniversaryLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function StarryAnniversaryLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function StarryAnniversaryLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function StarryAnniversaryLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function StarryAnniversaryLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function StarryAnniversaryLongRunControl:setLongRunLenAndStates()
...
function StarryAnniversaryLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function StarryAnniversaryLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function StarryAnniversaryLongRunControl:clearCurLongRunData()
...
function StarryAnniversaryLongRunControl:setFirstColBeginLongRun()
...
function StarryAnniversaryLongRunControl:getScatterNumByCol(_col)
    local scatterNum = 0
    for iRow = 1, self.m_machine.m_iReelRowNum do
        for iCol = 1, _col do
...
return StarryAnniversaryLongRunControl
