...
local LevelStarryAnniversaryConfig = class("LevelStarryAnniversaryConfig", LevelConfigData)

LevelStarryAnniversaryConfig.m_bnBasePro1 = nil
LevelStarryAnniversaryConfig.m_bnBaseTotalWeight1 = nil


function LevelStarryAnniversaryConfig:parsePro( value )
...
function LevelStarryAnniversaryConfig:parseSelfConfigData(colKey, colValue)
...
function LevelStarryAnniversaryConfig:getFixSymbolPro( )
...
function LevelStarryAnniversaryConfig:getValueByPros( proValues , totalWeight )
...
return  LevelStarryAnniversaryConfig