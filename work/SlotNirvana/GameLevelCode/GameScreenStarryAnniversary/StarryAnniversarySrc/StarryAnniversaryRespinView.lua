...
local StarryAnniversaryRespinView = class("StarryAnniversaryRespinView", util_require("Levels.RespinView"))
...
StarryAnniversaryRespinView.SYMBOL_BONUS = 94

function StarryAnniversaryRespinView:runNodeEnd(endNode)
        
end

function StarryAnniversaryRespinView:oneReelDown(colIndex)
    self.m_machine:respinOneReelDown(colIndex, self:getouchStatus() == ENUM_TOUCH_STATUS.QUICK_STOP)
end

function StarryAnniversaryRespinView:createRespinNode(symbolNode, status)
      ...
      local colorNode = util_createAnimation("Socre_StarryAnniversary_Empty.csb")
...
function StarryAnniversaryRespinView:initRespinElement(machineElement, machineRow, machineColmn, startCallFun)
      ...
      local linesNode = util_createAnimation("StarryAnniversary_RespinLines.csb")
...
function StarryAnniversaryRespinView:respinNodeEndCallBack(endNode, status)
    --层级调换
...
return StarryAnniversaryRespinView