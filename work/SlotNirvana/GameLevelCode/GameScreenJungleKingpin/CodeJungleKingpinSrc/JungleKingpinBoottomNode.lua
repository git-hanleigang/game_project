...
--xcyy
--2018年5月23日
--JungleKingpinBoottomNode.lua

local JungleKingpinBoottomNode = class("JungleKingpinBoottomNode",util_require("views.gameviews.GameBottomNode"))


function JungleKingpinBoottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim)
...
return JungleKingpinBoottomNode