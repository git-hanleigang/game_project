...
--xcyy
--2018年5月23日
--JungleKingpinSlotFastNode.lua

local JungleKingpinSlotFastNode = class("JungleKingpinSlotFastNode",util_require("Levels.SlotsNode"))
---
-- 还原到初始被创建的状态
function JungleKingpinSlotFastNode:reset(removeFlag)
...
-- 
function JungleKingpinSlotFastNode:initSlotNodeByCCBName(ccbName,symbolType)
...
-- 清空掉产生的数据
--
function JungleKingpinSlotFastNode:clearSlotoData()
...
return JungleKingpinSlotFastNode