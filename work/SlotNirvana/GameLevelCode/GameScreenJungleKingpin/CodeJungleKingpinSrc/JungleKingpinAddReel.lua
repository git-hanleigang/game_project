...
--island
--2018年4月12日
--JungleKingpinAddReel.lua
--
-- jackpot top bar
local SpeicalReel = require "Levels.SpeicalReel"
local JungleKingpinAddReel = class("JungleKingpinAddReel",SpeicalReel)

JungleKingpinAddReel.m_runState = nil
JungleKingpinAddReel.m_runSpeed = nil
JungleKingpinAddReel.m_endRunData = nil
JungleKingpinAddReel.m_allRunSymbols = nil

JungleKingpinAddReel.m_runActions = nil
JungleKingpinAddReel.m_runNowAction = nil

local BONUS_SYMBOL = 93
local INCREMENT_SPEED = 40        --速度增量 (像素/帧)
...
JungleKingpinAddReel.m_endCallBackFun = nil
JungleKingpinAddReel.m_PlayAddBonusFlyEffectCallBackFun = nil
JungleKingpinAddReel.m_reelHeight = nil

--状态切换
JungleKingpinAddReel.m_timeCount = 0
JungleKingpinAddReel.m_countDownTime = BEGIN_ACC_DELAY_TIME

JungleKingpinAddReel.m_randomDataFunc = nil

JungleKingpinAddReel.distance = 0

function JungleKingpinAddReel:initUI()
...
function JungleKingpinAddReel:initAction()
...
function JungleKingpinAddReel:initFirstSymbolBySymbols(initDataList, reelHeight)
...
function JungleKingpinAddReel:getDisToReelLowBoundary(node)
...
function JungleKingpinAddReel:getNextRunData()
...
function JungleKingpinAddReel:createNextNode()
...
--设置滚动序列
function JungleKingpinAddReel:getMoveActions()
      local runActions = {}
...
function JungleKingpinAddReel:initRunDate(runData, getRunDatafunc)
...
function JungleKingpinAddReel:setAllRunSymbols( allSymbols )
      self.m_allRunSymbols = allSymbols
end

function JungleKingpinAddReel:setEndDate(endData)
      self.m_endRunData = endData
end

function JungleKingpinAddReel:beginMove()
...
function JungleKingpinAddReel:checkBonusPos()
      ...
      for i=1,#childs do
            ...
            if Tag == BONUS_SYMBOL then
                  ...
                  if nowPosY < self.m_reelHeight/2 then
...
function JungleKingpinAddReel:changeRunState(dt)
...
function JungleKingpinAddReel:runResAction()
...
function JungleKingpinAddReel:playRunEndAnima()
...
function JungleKingpinAddReel:setEndCallBackFun(func)
      self.m_endCallBackFun = func
end

function JungleKingpinAddReel:setPlayAddBonusFlyEffectCallBackFun(func)
      self.m_PlayAddBonusFlyEffectCallBackFun = func
end



return JungleKingpinAddReel