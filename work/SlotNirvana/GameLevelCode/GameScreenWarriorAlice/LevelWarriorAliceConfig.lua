...
local LevelWarriorAliceConfig = class("LevelWarriorAliceConfig", LevelConfigData)

LevelWarriorAliceConfig.m_bnBasePro1 = nil
LevelWarriorAliceConfig.m_bnBaseTotalWeight1 = nil


function LevelWarriorAliceConfig:parsePro( value )
...
function LevelWarriorAliceConfig:CsvDataRule_ParseSelfData(colKey, colValue)
...
function LevelWarriorAliceConfig:getFixSymbolPro( )
...
function LevelWarriorAliceConfig:getValueByPros( proValues , totalWeight )
...
--
function LevelWarriorAliceConfig:getRespinReelDatasByColumnIndex(respinModelID,columnIndex)

	local colKey = string.format("freespinModeId_%d_%d",respinModelID,columnIndex)

	return self[colKey]
end

return  LevelWarriorAliceConfig