...
--xcyy
--2018年5月23日
--OwlsomeWizardBottomNode.lua

local OwlsomeWizardBottomNode = class("OwlsomeWizardBottomNode",util_require("views.gameviews.GameBottomNode"))

--获取当前Bet序号
function OwlsomeWizardBottomNode:getBetIndexById(betId)
...
function OwlsomeWizardBottomNode:changeBetCoinNumToLow()
...
return OwlsomeWizardBottomNode