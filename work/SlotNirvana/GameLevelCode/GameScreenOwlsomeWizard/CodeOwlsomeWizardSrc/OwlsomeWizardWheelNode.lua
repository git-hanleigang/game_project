...
--xcyy
--2018年5月23日
--OwlsomeWizardWheelNode.lua
local PublicConfig = require "OwlsomeWizardPublicConfig"
local OwlsomeWizardWheelNode = class("OwlsomeWizardWheelNode",util_require("Levels.BaseReel.BaseWheelNew"))
...
function OwlsomeWizardWheelNode:setSlowFunc(func)
...
function OwlsomeWizardWheelNode:startSchedule()
    --设置状态机
