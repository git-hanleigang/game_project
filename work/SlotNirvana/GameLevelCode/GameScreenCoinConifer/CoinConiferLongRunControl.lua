...
local CoinConiferLongRunControl = class("CoinConiferLongRunControl")

function CoinConiferLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function CoinConiferLongRunControl:getUsingReels()
    return self.usingReels
end

function CoinConiferLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function CoinConiferLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function CoinConiferLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function CoinConiferLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function CoinConiferLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function CoinConiferLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function CoinConiferLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function CoinConiferLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function CoinConiferLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function CoinConiferLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function CoinConiferLongRunControl:setLongRunLenAndStates()
...
function CoinConiferLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function CoinConiferLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function CoinConiferLongRunControl:clearCurLongRunData()
...
function CoinConiferLongRunControl:setFirstColBeginLongRun()
...
return CoinConiferLongRunControl
