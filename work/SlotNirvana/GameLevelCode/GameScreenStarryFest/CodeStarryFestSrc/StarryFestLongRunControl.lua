...
local StarryFestLongRunControl = class("StarryFestLongRunControl")

function StarryFestLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function StarryFestLongRunControl:getUsingReels()
    return self.usingReels
end

function StarryFestLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function StarryFestLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function StarryFestLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function StarryFestLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function StarryFestLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function StarryFestLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function StarryFestLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function StarryFestLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function StarryFestLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function StarryFestLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function StarryFestLongRunControl:setLongRunLenAndStates()
...
function StarryFestLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function StarryFestLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function StarryFestLongRunControl:clearCurLongRunData()
...
function StarryFestLongRunControl:setFirstColBeginLongRun()
...
return StarryFestLongRunControl
