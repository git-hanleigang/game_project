local StarryFestSymbol = class("StarryFestSymbol",util_require("Levels.BaseLevelDialog"))

-- 构造函数
function StarryFestSymbol:ctor()
    StarryFestSymbol.super.ctor(self)
...
function StarryFestSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function StarryFestSymbol:changeSymbolCcb(_symbolType)
...
function StarryFestSymbol:createAnimNode()
...
function StarryFestSymbol:upDateAnimNode()
...
function StarryFestSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function StarryFestSymbol:getNodeSpine()
...
-- 获取动画持续时间
--
function StarryFestSymbol:getAnimDurationTime(animName)
