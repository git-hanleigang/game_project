...
local LevelTreasureToadConfig = class("LevelTreasureToadConfig", LevelConfigData)

LevelTreasureToadConfig.m_bnBasePro1 = nil
LevelTreasureToadConfig.m_bnBaseTotalWeight1 = nil


function LevelTreasureToadConfig:parsePro( value )
...
function LevelTreasureToadConfig:parseSelfConfigData(colKey, colValue)
...
function LevelTreasureToadConfig:getFixSymbolPro( )
...
function LevelTreasureToadConfig:getValueByPros( proValues , totalWeight )
...
return  LevelTreasureToadConfig