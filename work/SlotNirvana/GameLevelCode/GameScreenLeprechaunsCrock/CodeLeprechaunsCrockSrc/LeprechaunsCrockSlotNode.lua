...
--fixios0223
local LeprechaunsCrockSlotNode = class("LeprechaunsCrockSlotNode",require("Levels.SlotsNode"))

---
-- 还原到初始被创建的状态
function LeprechaunsCrockSlotNode:reset()
...
return LeprechaunsCrockSlotNode