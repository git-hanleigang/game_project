...
local ScarabChestLongRunControl = class("ScarabChestLongRunControl")

function ScarabChestLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function ScarabChestLongRunControl:getUsingReels()
    return self.usingReels
end

function ScarabChestLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function ScarabChestLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function ScarabChestLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function ScarabChestLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function ScarabChestLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function ScarabChestLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function ScarabChestLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function ScarabChestLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function ScarabChestLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function ScarabChestLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function ScarabChestLongRunControl:setLongRunLenAndStates()
...
function ScarabChestLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function ScarabChestLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function ScarabChestLongRunControl:clearCurLongRunData()
...
function ScarabChestLongRunControl:setFirstColBeginLongRun()
...
return ScarabChestLongRunControl
