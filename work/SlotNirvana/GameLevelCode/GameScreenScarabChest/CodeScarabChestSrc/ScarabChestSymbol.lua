local ScarabChestSymbol = class("ScarabChestSymbol",util_require("Levels.BaseLevelDialog"))

-- 构造函数
function ScarabChestSymbol:ctor()
    ScarabChestSymbol.super.ctor(self)
...
function ScarabChestSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function ScarabChestSymbol:changeSymbolCcb(_symbolType)
...
function ScarabChestSymbol:createAnimNode()
...
function ScarabChestSymbol:upDateAnimNode()
...
function ScarabChestSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function ScarabChestSymbol:getNodeSpine()
    return self.m_animNode
end

function ScarabChestSymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function ScarabChestSymbol:getAnimDurationTime(animName)
