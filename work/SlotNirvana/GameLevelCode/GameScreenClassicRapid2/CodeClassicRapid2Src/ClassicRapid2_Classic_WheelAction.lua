...
--smy
--2018年4月18日
--ClassicRapid2_Classic_WheelAction.lua


local ClassicRapid2_Classic_WheelAction = class("ClassicRapid2_Classic_WheelAction", util_require("base.BaseWheel"))

function ClassicRapid2_Classic_WheelAction:ctor(node, num, func,setRotFunc,Array)
    self.m_target = node
    ...
    self.m_runV = 500--匀速
    self.m_runTime = 0 --匀速时间
    self.m_slowA = 200 --动态减速度
    self.m_slowQ = 1 --减速圈数
    self.m_stopV = 150 --停止时速度
...
function ClassicRapid2_Classic_WheelAction:changeWheelRunData( Array)
...
function ClassicRapid2_Classic_WheelAction:beginWheel(isAnti)
...
function ClassicRapid2_Classic_WheelAction:setWheelRotFunc( setRotFunc )
    self.m_setRotFunc = setRotFunc
end

--保存时间
function ClassicRapid2_Classic_WheelAction:saveTime()
    self.m_curTime = socket.gettime()
end

--读取时间间隔
function ClassicRapid2_Classic_WheelAction:getSpanTime()
    local spanTime = (socket.gettime() - self.m_curTime)
    return spanTime
end

function ClassicRapid2_Classic_WheelAction:recvData(index)
...
function ClassicRapid2_Classic_WheelAction:overWheel()
...
return ClassicRapid2_Classic_WheelAction