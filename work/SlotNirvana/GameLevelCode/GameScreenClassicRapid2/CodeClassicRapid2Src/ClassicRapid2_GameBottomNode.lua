...
local ClassicRapid2_GameBottomNode = class("ClassicRapid2_GameBottomNode", util_require("views.gameviews.GameBottomNode"))
---
-- wincoin 是本次赢取了多少钱
-- @param 第三个参数，用来处理显示赢钱时 不需要播放数字变化动画
--
function ClassicRapid2_GameBottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim,reduce)
...
return ClassicRapid2_GameBottomNode