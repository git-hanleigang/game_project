...
local ClassicRapidSlotNode = class("ClassicRapidSlotNode",util_require("Levels.SlotsNode"))

ClassicRapidSlotNode.p_idleIsLoop = nil -- 动画是否需要循环

function ClassicRapidSlotNode:init()
...
---
-- 还原到初始被创建的状态
function ClassicRapidSlotNode:reset()
...
function ClassicRapidSlotNode:runIdleAnim()
...
function ClassicRapidSlotNode:runAnim(animName,loop,func)
