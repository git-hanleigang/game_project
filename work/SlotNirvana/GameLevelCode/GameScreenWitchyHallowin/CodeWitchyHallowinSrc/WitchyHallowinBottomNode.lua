...
--xcyy
--2018年5月23日
--WitchyHallowinBottomNode.lua

local WitchyHallowinBottomNode = class("WitchyHallowinBottomNode", util_require("views.gameviews.GameBottomNode"))

function WitchyHallowinBottomNode:createCoinWinEffectUI()
...
-- 修改已创建的收集反馈效果
function WitchyHallowinBottomNode:changeCoinWinEffectUI(_levelName, _csbName)
...
function WitchyHallowinBottomNode:playCoinWinEffectUI(callBack)
    local coinBottomEffectNode = self.coinBottomEffectNode
    if coinBottomEffectNode ~= nil then
        util_resetCsbAction(coinBottomEffectNode.m_csbAct)
...
return WitchyHallowinBottomNode
