local PudgyPandaSymbol = class("PudgyPandaSymbol",util_require("Levels.BaseLevelDialog"))

-- 构造函数
function PudgyPandaSymbol:ctor()
    PudgyPandaSymbol.super.ctor(self)
...
function PudgyPandaSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function PudgyPandaSymbol:changeSymbolCcb(_symbolType)
...
function PudgyPandaSymbol:createAnimNode()
...
function PudgyPandaSymbol:upDateAnimNode()
...
function PudgyPandaSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function PudgyPandaSymbol:getNodeSpine()
    return self.m_animNode
end

function PudgyPandaSymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function PudgyPandaSymbol:getAnimDurationTime(animName)
