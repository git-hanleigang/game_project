...
--island
--2018年4月12日
--GoldExpressJackPotWinView.lua
---- respin 玩法结算时中 mini mijor等提示界面
local GoldExpressJackPotWinView = class("GoldExpressJackPotWinView", util_require("base.BaseView"))

function GoldExpressJackPotWinView:initUI(data)
    self.m_click = false

    local resourceFilename = "GoldExpress/JackpotLayer.csb"
    self:createCsbNode(resourceFilename)

end

function GoldExpressJackPotWinView:initViewData(index,coins,callBackFun)
    self.m_index = index
...
function GoldExpressJackPotWinView:onEnter()
end

function GoldExpressJackPotWinView:onExit()
    
end

function GoldExpressJackPotWinView:clickFunc(sender)
...
return GoldExpressJackPotWinView