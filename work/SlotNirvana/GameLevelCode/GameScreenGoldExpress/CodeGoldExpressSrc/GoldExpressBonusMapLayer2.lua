...
local GoldExpressBonusMapLayer2 = class("GoldExpressBonusMapLayer2", BaseScroll)

GoldExpressBonusMapLayer2.AUTO_STOP_SPEED = 1    -- 惯性滑动停止速度
GoldExpressBonusMapLayer2.AUTO_IN_MOVE = 10      -- 手势滑动开启平均值
GoldExpressBonusMapLayer2.AUTO_FRICTIONE = 0.8  -- 摩擦力
GoldExpressBonusMapLayer2.AUTO_MAX_SPEED = 40   -- 速度峰值
GoldExpressBonusMapLayer2.DELTA_SPEED = 0.3    -- 惯性初速度系数

GoldExpressBonusMapLayer2.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function GoldExpressBonusMapLayer2:initContent(node)
    self.m_content = node
...
function GoldExpressBonusMapLayer2:touchMoveLogic(touch, event)
...
function GoldExpressBonusMapLayer2:setParent(parent)
    self.m_parent = parent
end

return GoldExpressBonusMapLayer2