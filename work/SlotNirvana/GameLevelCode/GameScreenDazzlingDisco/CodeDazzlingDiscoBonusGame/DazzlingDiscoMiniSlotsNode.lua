...
--xcyy
--2018年5月23日
--DazzlingDiscoMiniSlotsNode.lua

local DazzlingDiscoMiniSlotsNode = class("DazzlingDiscoMiniSlotsNode",util_require("Levels.SlotsNode"))

---
-- 传递进来的ccbName 不带有.ccbi 后缀， 主要是为了方便注册
-- symbol 对应的节点JS Controller 名字与ccbi一致
-- 
function DazzlingDiscoMiniSlotsNode:initSlotNodeByCCBName(ccbName,symbolType)
    --    if ccbName == nil then
...
function DazzlingDiscoMiniSlotsNode:setMachine(machine)
    self.m_machine = machine
end

return DazzlingDiscoMiniSlotsNode