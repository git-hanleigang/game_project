...
--xcyy
--2018年5月23日
--DazzlingDiscoBonusOverView.lua
local PublicConfig = require "DazzlingDiscoPublicConfig"
local DazzlingDiscoBonusOverView = class("DazzlingDiscoBonusOverView",util_require("Levels.BaseLevelDialog"))


function DazzlingDiscoBonusOverView:initUI(params)
    ...
    local btn = self.m_btn_csb:findChild("Button_socialover")  
    btn:setVisible(true)
...
function DazzlingDiscoBonusOverView:clickFunc(sender)
    ...
    gLobalSoundManager:playSound(PublicConfig.SoundConfig.sound_DazzlingDisco_hide_bonus_over_view)
...
return DazzlingDiscoBonusOverView