...
---
--获取b不同情况下bonus假滚动数据
function LevelWestRangerConfig:getSpecialRespinCloumnByColumnIndex(columnIndex)
	local colKey = "reel_cloumn_special"..columnIndex
...
function LevelWestRangerConfig:getRespinCloumnByColumnIndex(columnIndex)
