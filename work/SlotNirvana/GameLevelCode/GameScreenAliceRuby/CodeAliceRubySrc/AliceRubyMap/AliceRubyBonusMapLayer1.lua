...
local AliceRubyBonusMapLayer1 = class("AliceRubyBonusMapLayer1", BaseScroll)

AliceRubyBonusMapLayer1.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function AliceRubyBonusMapLayer1:initContent(node)
    self.m_content = node
...
function AliceRubyBonusMapLayer1:setMoveFunc( _func )
    self.m_moveFunc = _func
end

function AliceRubyBonusMapLayer1:move(x)
...
function AliceRubyBonusMapLayer1:setParent(parent)
    self.m_parent = parent
end

return AliceRubyBonusMapLayer1