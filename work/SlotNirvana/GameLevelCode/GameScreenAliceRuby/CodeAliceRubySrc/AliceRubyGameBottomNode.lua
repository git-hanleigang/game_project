...
local AliceRubyGameBottomNode = class("AliceRubyGameBottomNode", util_require("views.gameviews.GameBottomNode"))
AliceRubyGameBottomNode.isAddLineWin = true

function AliceRubyGameBottomNode:setMachine(machine )
    self.m_machine = machine
end

function AliceRubyGameBottomNode:setIsAddLineWin(isAdd)
...
--
function AliceRubyGameBottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim)
...
function AliceRubyGameBottomNode:clearWinLabel( )
    self:checkClearWinLabel()
end

return  AliceRubyGameBottomNode