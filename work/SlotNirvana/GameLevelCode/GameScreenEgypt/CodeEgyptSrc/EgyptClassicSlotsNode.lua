...
--xcyy
--2018年5月23日
--EgyptClassicSlotsNode.lua
local SlotsNode = require("Levels.SlotsNode")
local EgyptClassicSlotsNode = class("EgyptClassicSlotsNode", SlotsNode)
EgyptClassicSlotsNode.m_mark = nil
EgyptClassicSlotsNode.p_levelPushAnimNodeCallFun = nil
EgyptClassicSlotsNode.p_levelGetAnimNodeCallFun = nil

function EgyptClassicSlotsNode:removeAndPushCcbToPool()
...
function EgyptClassicSlotsNode:initSlotNodeByCCBName(ccbName,symbolType)
    --    if ccbName == nil then
...
---
-- 还原到初始被创建的状态
function EgyptClassicSlotsNode:reset()
...
function EgyptClassicSlotsNode:clear()
...
function EgyptClassicSlotsNode:checkLoadCCbNode()
