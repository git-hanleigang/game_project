...
local SpookySnacksLongRunControl = class("SpookySnacksLongRunControl")

function SpookySnacksLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function SpookySnacksLongRunControl:getUsingReels()
    return self.usingReels
end

function SpookySnacksLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function SpookySnacksLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function SpookySnacksLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function SpookySnacksLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function SpookySnacksLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function SpookySnacksLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function SpookySnacksLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function SpookySnacksLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function SpookySnacksLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function SpookySnacksLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function SpookySnacksLongRunControl:setLongRunLenAndStates()
...
function SpookySnacksLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function SpookySnacksLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function SpookySnacksLongRunControl:clearCurLongRunData()
...
function SpookySnacksLongRunControl:setFirstColBeginLongRun()
...
return SpookySnacksLongRunControl
