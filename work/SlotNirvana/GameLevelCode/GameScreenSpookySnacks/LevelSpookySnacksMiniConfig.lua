...
local LevelSpookySnacksMiniConfig = class("LevelSpookySnacksMiniConfig", LevelConfigData)

LevelSpookySnacksMiniConfig.m_bnBasePro1 = nil
LevelSpookySnacksMiniConfig.m_bnBaseTotalWeight1 = nil


function LevelSpookySnacksMiniConfig:parsePro( value )
...
function LevelSpookySnacksMiniConfig:parseSelfConfigData(colKey, colValue)
...
function LevelSpookySnacksMiniConfig:getFixSymbolPro( )
...
function LevelSpookySnacksMiniConfig:getValueByPros( proValues , totalWeight )
...
function LevelSpookySnacksMiniConfig:getRespinCloumnByColumnIndex(columnIndex)
...
return  LevelSpookySnacksMiniConfig