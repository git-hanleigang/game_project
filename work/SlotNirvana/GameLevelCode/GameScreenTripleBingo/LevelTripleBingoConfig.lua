...
local LevelTripleBingoConfig = class("LevelTripleBingoConfig", LevelConfigData)

LevelTripleBingoConfig.m_bnBasePro1 = nil
LevelTripleBingoConfig.m_bnBaseTotalWeight1 = nil


function LevelTripleBingoConfig:parsePro( value )
...
function LevelTripleBingoConfig:parseSelfConfigData(colKey, colValue)
...
function LevelTripleBingoConfig:getFixSymbolPro( )
...
function LevelTripleBingoConfig:getValueByPros( proValues , totalWeight )
