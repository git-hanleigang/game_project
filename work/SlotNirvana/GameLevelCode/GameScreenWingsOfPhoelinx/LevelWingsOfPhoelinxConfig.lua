...
local LevelWingsOfPhoelinxConfig = class("LevelWingsOfPhoelinxConfig", LevelConfigData)

LevelWingsOfPhoelinxConfig.m_bnBasePro1 = nil
LevelWingsOfPhoelinxConfig.m_bnBaseTotalWeight1 = nil


function LevelWingsOfPhoelinxConfig:parsePro( value )
...
function LevelWingsOfPhoelinxConfig:parseSelfConfigData(colKey, colValue)
...
function LevelWingsOfPhoelinxConfig:getFixSymbolPro( )
...
function LevelWingsOfPhoelinxConfig:getValueByPros( proValues , totalWeight )
...
return  LevelWingsOfPhoelinxConfig