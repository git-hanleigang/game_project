...
local LevelAChristmasCarolConfig = class("LevelAChristmasCarolConfig", LevelConfigData)

LevelAChristmasCarolConfig.m_bnBasePro1 = nil
LevelAChristmasCarolConfig.m_bnBaseTotalWeight1 = nil


function LevelAChristmasCarolConfig:parsePro( value )
...
function LevelAChristmasCarolConfig:parseSelfConfigData(colKey, colValue)
...
function LevelAChristmasCarolConfig:getFixSymbolPro( )
...
function LevelAChristmasCarolConfig:getValueByPros( proValues , totalWeight )
...
return  LevelAChristmasCarolConfig