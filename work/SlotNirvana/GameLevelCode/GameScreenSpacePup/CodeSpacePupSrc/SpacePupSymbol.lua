local SpacePupSymbol = class("SpacePupSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function SpacePupSymbol:ctor()
    SpacePupSymbol.super.ctor(self)
...
function SpacePupSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function SpacePupSymbol:changeSymbolCcb(_symbolType)
...
function SpacePupSymbol:createAnimNode()
...
function SpacePupSymbol:upDateAnimNode()
...
function SpacePupSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function SpacePupSymbol:getNodeSpine()
    return self.m_animNode
end

function SpacePupSymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function SpacePupSymbol:getAnimDurationTime(animName)
