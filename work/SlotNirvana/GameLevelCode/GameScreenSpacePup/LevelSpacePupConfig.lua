...
local LevelSpacePupConfig = class("LevelSpacePupConfig", LevelConfigData)

LevelSpacePupConfig.m_bnBasePro1 = nil
LevelSpacePupConfig.m_bnBaseTotalWeight1 = nil

function LevelSpacePupConfig:ctor()
      LevelConfigData.ctor(self)
end


function LevelSpacePupConfig:parseSelfConfigData(colKey, colValue)
...
function LevelSpacePupConfig:getBnBasePro(type)
      if type == 1 then
...
--需要提高层级的类型
function LevelSpacePupConfig:checkSpecialSymbol(symbolType)
