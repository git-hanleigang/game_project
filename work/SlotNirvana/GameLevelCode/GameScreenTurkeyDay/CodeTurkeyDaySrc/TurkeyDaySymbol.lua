local TurkeyDaySymbol = class("TurkeyDaySymbol",util_require("Levels.BaseLevelDialog"))

-- 构造函数
function TurkeyDaySymbol:ctor()
    TurkeyDaySymbol.super.ctor(self)
...
function TurkeyDaySymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function TurkeyDaySymbol:changeSymbolCcb(_symbolType)
...
function TurkeyDaySymbol:createAnimNode()
...
function TurkeyDaySymbol:upDateAnimNode()
...
function TurkeyDaySymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function TurkeyDaySymbol:getNodeSpine()
...
-- 获取动画持续时间
--
function TurkeyDaySymbol:getAnimDurationTime(animName)
