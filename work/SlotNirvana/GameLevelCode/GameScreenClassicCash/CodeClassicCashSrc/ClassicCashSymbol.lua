local ClassicCashSymbol = class("ClassicCashSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function ClassicCashSymbol:ctor()
    ClassicCashSymbol.super.ctor(self)
...
function ClassicCashSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function ClassicCashSymbol:changeSymbolCcb(_symbolType)
...
function ClassicCashSymbol:createAnimNode()
...
function ClassicCashSymbol:upDateAnimNode()
...
function ClassicCashSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function ClassicCashSymbol:getNodeSpine()
    return self.m_animNode
end

function ClassicCashSymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function ClassicCashSymbol:getAnimDurationTime(animName)
