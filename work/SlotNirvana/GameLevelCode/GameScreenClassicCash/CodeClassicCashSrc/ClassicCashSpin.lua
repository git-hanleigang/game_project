...
local ClassicCashSpin = class("ClassicCashSpin", 
                                    util_require("views.gameviews.SpinBtn"))


ClassicCashSpin.m_machine = nil                                   ---
--
function ClassicCashSpin:btnTouchBegan(sender)
...
function ClassicCashSpin:setMachine( machine)

      self.m_machine  = machine

end

return ClassicCashSpin