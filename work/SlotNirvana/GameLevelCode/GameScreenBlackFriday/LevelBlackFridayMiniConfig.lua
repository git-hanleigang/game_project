...
local LevelBlackFridayMiniConfig = class("LevelBlackFridayMiniConfig", LevelConfigData)

LevelBlackFridayMiniConfig.m_bnBasePro1 = nil
LevelBlackFridayMiniConfig.m_bnBaseTotalWeight1 = nil


function LevelBlackFridayMiniConfig:parsePro( value )
...
function LevelBlackFridayMiniConfig:parseSelfConfigData(colKey, colValue)
...
function LevelBlackFridayMiniConfig:getFixSymbolPro( )
...
function LevelBlackFridayMiniConfig:getValueByPros( proValues , totalWeight )
...
function LevelBlackFridayMiniConfig:getRespinCloumnByColumnIndex(columnIndex)
...
return  LevelBlackFridayMiniConfig