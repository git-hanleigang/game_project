...
local LevelBlackFridayConfig = class("LevelBlackFridayConfig", LevelConfigData)

LevelBlackFridayConfig.m_bnBasePro1 = nil
LevelBlackFridayConfig.m_bnBaseTotalWeight1 = nil
LevelBlackFridayConfig.m_isFirstComeIn = false


function LevelBlackFridayConfig:parsePro( value )
...
function LevelBlackFridayConfig:parseSelfConfigData(colKey, colValue)
...
function LevelBlackFridayConfig:getFixSymbolPro( )
...
function LevelBlackFridayConfig:getValueByPros( proValues , totalWeight )
...
function LevelBlackFridayConfig:isHaveInitReel()
...
function LevelBlackFridayConfig:getIsFirstComeIn( )
    return self.m_isFirstComeIn
end

return  LevelBlackFridayConfig