...
local WheelOfRomanceWheelAction = class("WheelOfRomanceWheelAction", util_require("base.BaseWheel"))

function WheelOfRomanceWheelAction:ctor(node, num, func,setRotFunc,Array)
    self.m_target = node
...
function WheelOfRomanceWheelAction:changeWheelRunData( Array)
...
function WheelOfRomanceWheelAction:setWheelRotFunc( setRotFunc )
    self.m_setRotFunc = setRotFunc
end


function WheelOfRomanceWheelAction:recvData(index,dirType)
...
return WheelOfRomanceWheelAction