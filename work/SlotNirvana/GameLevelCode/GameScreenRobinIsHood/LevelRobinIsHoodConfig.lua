...
local LevelRobinIsHoodConfig = class("LevelRobinIsHoodConfig", LevelConfigData)

LevelRobinIsHoodConfig.m_bnBasePro1 = nil
LevelRobinIsHoodConfig.m_bnBaseTotalWeight1 = nil


function LevelRobinIsHoodConfig:parsePro( value )
...
function LevelRobinIsHoodConfig:parseSelfConfigData(colKey, colValue)
...
function LevelRobinIsHoodConfig:getFixSymbolPro( )
...
function LevelRobinIsHoodConfig:getValueByPros( proValues , totalWeight )
