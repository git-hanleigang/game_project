...
local RobinIsHoodLongRunControl = class("RobinIsHoodLongRunControl")

function RobinIsHoodLongRunControl:initData_(_machine)
...
-- 可以用这个接口来快速调快滚计算的假数据
function RobinIsHoodLongRunControl:getUsingReels()
    return self.usingReels
end

function RobinIsHoodLongRunControl:setUsingReels(_reels)
    self.usingReels = _reels
end

function RobinIsHoodLongRunControl:getLongRunInfoFromReel(_symbolTypes, _LegitimateCol, _LegitimateNum, _isContinuity)
...
function RobinIsHoodLongRunControl:getLongRun1toMaxColInfos(_symbolTypes, _legitimateNum)
...
function RobinIsHoodLongRunControl:getLongRun135ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function RobinIsHoodLongRunControl:getLongRun234ColInfos(_symbolTypes, _legitimateNum)
    -- 默认规则，一列只出同一个类型中的一个，两个以上开始快滚
...
function RobinIsHoodLongRunControl:getLongRunAnyNumAnyWhereInfos(_symbolTypes, _legitimateNum)
...
function RobinIsHoodLongRunControl:getLongRunAnyNumContinuityInfos(_symbolTypes, _legitimateNum)
...
function RobinIsHoodLongRunControl:getLongRunMustRunInfos(_symbolTypes, _legitimateNum, _musRunInfos)
    -- 默认规则，从左到右连续出现规定个数(默认四个)以上后，下一列就快滚，必须不能列中断出现
    local legitimateCol = {}
...
function RobinIsHoodLongRunControl:getLongRunStartAndEndColFromId(_longRunId, _symbolTypes, _legitimateNum, _musRunInfos)
    local infos = {}
...
function RobinIsHoodLongRunControl:getLongRunStartAndEndCol(_longRunConfigs)
    local longRunData = {}
    local longRunInfos = {}
...
function RobinIsHoodLongRunControl:setLongRunLenAndStates()
...
function RobinIsHoodLongRunControl:setCurLongRunData(_longRunData)
    self.m_curLongRunData = _longRunData
end

function RobinIsHoodLongRunControl:getCurLongRunData()
    return self.m_curLongRunData
end

function RobinIsHoodLongRunControl:clearCurLongRunData()
...
function RobinIsHoodLongRunControl:setFirstColBeginLongRun()
...
return RobinIsHoodLongRunControl
