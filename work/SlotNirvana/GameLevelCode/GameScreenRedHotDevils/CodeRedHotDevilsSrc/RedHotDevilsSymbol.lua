local RedHotDevilsSymbol = class("RedHotDevilsSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function RedHotDevilsSymbol:ctor()
    RedHotDevilsSymbol.super.ctor(self)
...
function RedHotDevilsSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function RedHotDevilsSymbol:changeSymbolCcb(_symbolType)
...
function RedHotDevilsSymbol:createAnimNode()
...
function RedHotDevilsSymbol:upDateAnimNode()
...
function RedHotDevilsSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function RedHotDevilsSymbol:getNodeSpine()
