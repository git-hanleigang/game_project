local WickedWinsSymbol = class("WickedWinsSymbol",util_require("Levels.BaseLevelDialog"))


-- 构造函数
function WickedWinsSymbol:ctor()
    WickedWinsSymbol.super.ctor(self)
...
function WickedWinsSymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function WickedWinsSymbol:changeSymbolCcb(_symbolType)
...
function WickedWinsSymbol:createAnimNode()
...
function WickedWinsSymbol:upDateAnimNode()
...
function WickedWinsSymbol:runAnim(animName,loop,func)
    self:createAnimNode()
