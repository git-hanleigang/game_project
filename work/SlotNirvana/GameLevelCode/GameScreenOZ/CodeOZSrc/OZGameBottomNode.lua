...
--xcyy
--2018年5月23日
--OZGameBottomNode.lua

local OZGameBottomNode = class("OZGameBottomNode",util_require("views.gameviews.GameBottomNode"))

---
-- wincoin 是本次赢取了多少钱
-- @param 第三个参数，用来处理显示赢钱时 不需要播放数字变化动画
--
function OZGameBottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim)
