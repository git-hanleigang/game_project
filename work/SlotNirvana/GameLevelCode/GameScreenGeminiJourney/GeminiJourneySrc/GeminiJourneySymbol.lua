local GeminiJourneySymbol = class("GeminiJourneySymbol",util_require("Levels.BaseLevelDialog"))

-- 构造函数
function GeminiJourneySymbol:ctor()
    GeminiJourneySymbol.super.ctor(self)
...
function GeminiJourneySymbol:initDatas(_m_machine)
    self.m_machine   = _m_machine
end

function GeminiJourneySymbol:changeSymbolCcb(_symbolType)
...
function GeminiJourneySymbol:createAnimNode()
...
function GeminiJourneySymbol:upDateAnimNode()
...
function GeminiJourneySymbol:runAnim(animName,loop,func)
    self:createAnimNode()
...
function GeminiJourneySymbol:getNodeSpine()
    return self.m_animNode
end

function GeminiJourneySymbol:getCcbProperty(propName)
...
-- 获取动画持续时间
--
function GeminiJourneySymbol:getAnimDurationTime(animName)
