...
local LevelCrazyBombConfig = class("LevelCrazyBombConfig", LevelConfigData)


LevelCrazyBombConfig.m_vecPigShape2x2 = nil
LevelCrazyBombConfig.m_vecPigShape2x2Pro = nil
LevelCrazyBombConfig.iPigShape2x2TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape2x3 = nil
LevelCrazyBombConfig.m_vecPigShape2x3Pro = nil
LevelCrazyBombConfig.iPigShape2x3TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape2x4 = nil
LevelCrazyBombConfig.m_vecPigShape2x4Pro = nil
LevelCrazyBombConfig.iPigShape2x4TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape3x3 = nil
LevelCrazyBombConfig.m_vecPigShape3x3Pro = nil
LevelCrazyBombConfig.iPigShape3x3TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape2x5 = nil
LevelCrazyBombConfig.m_vecPigShape2x5Pro = nil
LevelCrazyBombConfig.iPigShape2x5TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape3x4 = nil
LevelCrazyBombConfig.m_vecPigShape3x4Pro = nil
LevelCrazyBombConfig.iPigShape3x4TotalWeight = nil

LevelCrazyBombConfig.m_vecPigShape3x5 = nil
LevelCrazyBombConfig.m_vecPigShape3x5Pro = nil
LevelCrazyBombConfig.iPigShape3x5TotalWeight = nil

LevelCrazyBombConfig.m_vecChooseRespin = nil

function LevelCrazyBombConfig:ctor()
      LevelConfigData.ctor(self)
end



function LevelCrazyBombConfig:parseSelfConfigData(colKey, colValue)
...
function LevelCrazyBombConfig:getPigShapePro(area)
      if area == 4 then
  ...
  -- 金块滚动数据
function LevelCrazyBombConfig:getPigShapeShow(area)
      if area == 4 then
