...
local PandaDeluxeShowBetView = class("PandaDeluxeShowBetView",util_require("Levels.BaseLevelDialog"))


function PandaDeluxeShowBetView:initUI(_machine)
    self.m_machine = _machine

    self:createCsbNode("PandaDeluxe/PandaDeluxe_RaiseBetTips.csb")
...
--默认按钮监听回调
function PandaDeluxeShowBetView:clickFunc(sender)
...
function PandaDeluxeShowBetView:onEnter()
    PandaDeluxeShowBetView.super.onEnter(self)
end

function PandaDeluxeShowBetView:onExit()
    PandaDeluxeShowBetView.super.onExit(self)
end

function PandaDeluxeShowBetView:setUI()
