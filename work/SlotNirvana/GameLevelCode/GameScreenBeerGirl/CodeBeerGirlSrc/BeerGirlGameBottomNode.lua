...
local BeerGirlGameBottomNode = class("BeerGirlGameBottomNode", util_require("views.gameviews.GameBottomNode"))


function BeerGirlGameBottomNode:setMachine(machine )
...
--
function BeerGirlGameBottomNode:notifyUpdateWinLabel(winCoin,isUpdateTopUI,isPlayAnim)
