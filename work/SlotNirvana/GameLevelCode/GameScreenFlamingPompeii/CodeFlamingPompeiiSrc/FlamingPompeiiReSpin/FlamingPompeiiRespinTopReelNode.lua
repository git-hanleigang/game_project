local FlamingPompeiiRespinTopReelNode = class("FlamingPompeiiRespinTopReelNode",util_require("Levels.BaseReel.BaseReelNode"))
...
function FlamingPompeiiRespinTopReelNode:ctor(params)
    FlamingPompeiiRespinTopReelNode.super.ctor(self,params)
...
function FlamingPompeiiRespinTopReelNode:createClipNode()
...
function FlamingPompeiiRespinTopReelNode:startSchedule()
    --先加速再匀速后减速
...
function FlamingPompeiiRespinTopReelNode:checkChangeSpeed(dt)
...
function FlamingPompeiiRespinTopReelNode:getNextSymbolType()
...
function FlamingPompeiiRespinTopReelNode:reloadRollNode(rollNode,rowIndex)
...
function FlamingPompeiiRespinTopReelNode:removeSymbolFromRollNode(rollNode)
...
function FlamingPompeiiRespinTopReelNode:updateRollNodePos(offset)
...
function FlamingPompeiiRespinTopReelNode:scaleRollNode(rollNode,rowIndex)
    local scale = 1
