...
local LevelMayanMysteryConfig = class("LevelMayanMysteryConfig", LevelConfigData)

LevelMayanMysteryConfig.m_bnBasePro1 = nil
LevelMayanMysteryConfig.m_bnBaseTotalWeight1 = nil


function LevelMayanMysteryConfig:parsePro( value )
...
function LevelMayanMysteryConfig:CsvDataRule_ParseSelfData(colKey, colValue)
...
function LevelMayanMysteryConfig:getFixSymbolPro( )
...
function LevelMayanMysteryConfig:getValueByPros( proValues , totalWeight )
...
return  LevelMayanMysteryConfig