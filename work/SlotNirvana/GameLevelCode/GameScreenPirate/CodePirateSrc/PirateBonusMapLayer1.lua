...
local PirateBonusMapLayer1 = class("PirateBonusMapLayer1", BaseScroll)

PirateBonusMapLayer1.BOUNDRAY_LEN = 0    -- 边缘回弹距离
-- 构造函数
function PirateBonusMapLayer1:initContent(node)
    self.m_content = node
...
function PirateBonusMapLayer1:move(x)
...
function PirateBonusMapLayer1:setParent(parent)
    self.m_parent = parent
end

return PirateBonusMapLayer1