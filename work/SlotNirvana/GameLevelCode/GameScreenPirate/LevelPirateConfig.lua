...
local LevelPirateConfig = class("LevelPirateConfig", LevelConfigData)

function LevelPirateConfig:ctor()
    LevelConfigData.ctor(self)
end
function LevelPirateConfig:initMachine(machine)
	self.m_machine=machine
end

function LevelPirateConfig:getNormalReelDatasByColumnIndex(columnIndex)
...
--
function LevelPirateConfig:getFsReelDatasByColumnIndex(fsModelID,columnIndex)
