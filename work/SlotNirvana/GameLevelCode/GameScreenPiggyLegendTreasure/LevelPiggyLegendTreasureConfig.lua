...
local LevelPiggyLegendTreasureConfig = class("LevelPiggyLegendTreasureConfig", LevelConfigData)

LevelPiggyLegendTreasureConfig.m_bnBasePro1 = nil
LevelPiggyLegendTreasureConfig.m_bnBaseTotalWeight1 = nil


function LevelPiggyLegendTreasureConfig:parsePro( value )
...
function LevelPiggyLegendTreasureConfig:parseSelfConfigData(colKey, colValue)
...
function LevelPiggyLegendTreasureConfig:getFixSymbolPro( )
...
function LevelPiggyLegendTreasureConfig:getValueByPros( proValues , totalWeight )
...
return  LevelPiggyLegendTreasureConfig