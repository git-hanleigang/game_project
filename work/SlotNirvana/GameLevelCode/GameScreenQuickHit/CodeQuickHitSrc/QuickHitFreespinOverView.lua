...
--smy
--2018年4月18日
--QuickHitFreespinOverView.lua


local QuickHitFreespinOverView = class("QuickHitFreespinOverView", util_require("base.BaseView"))

QuickHitFreespinOverView.soundIdArrays = nil
QuickHitFreespinOverView.isSoundNotPlayed = true

function QuickHitFreespinOverView:initUI()
    self:createCsbNode("QuickHit/Bonusfreespin3.csb")
...
function QuickHitFreespinOverView:jumpLab( )
...
function QuickHitFreespinOverView:updateCoins( )
...
function QuickHitFreespinOverView:initViewData(coins,num,callBackFun)
...
function QuickHitFreespinOverView:onEnter()
    self:runCsbAction("start",false,function(  )
        self:runCsbAction("idle",true)
    end)
end

function QuickHitFreespinOverView:onExit()
...
--点击回调
function QuickHitFreespinOverView:clickFunc(sender)
...
function QuickHitFreespinOverView:removeSelf( )
...
return QuickHitFreespinOverView