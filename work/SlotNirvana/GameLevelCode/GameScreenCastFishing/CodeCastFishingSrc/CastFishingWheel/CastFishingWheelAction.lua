local CastFishingWheelAction = class("CastFishingWheelAction", util_require("base.BaseWheel"))

function CastFishingWheelAction:ctor(node, num, func,setRotFunc,Array)
    self.m_target = node
...
function CastFishingWheelAction:resetData()
    self.m_status = self.ACTION_READY
    self.m_isWheelData = false
    self.m_targetDistance = 0
    self.m_moveDistance = 0
...
function CastFishingWheelAction:changeWheelRunData( Array)
...
function CastFishingWheelAction:setWheelRotFunc( setRotFunc )
    self.m_setRotFunc = setRotFunc
end

function CastFishingWheelAction:recvData(index)
