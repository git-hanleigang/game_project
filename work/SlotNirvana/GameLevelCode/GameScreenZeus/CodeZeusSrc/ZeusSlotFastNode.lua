...
--xcyy
--2018年5月23日
--ZeusSlotFastNode.lua

local ZeusSlotFastNode = class("ZeusSlotFastNode",util_require("Levels.SlotsNode"))

ZeusSlotFastNode.m_specialRunUI = nil

---
-- 还原到初始被创建的状态
function ZeusSlotFastNode:reset()
