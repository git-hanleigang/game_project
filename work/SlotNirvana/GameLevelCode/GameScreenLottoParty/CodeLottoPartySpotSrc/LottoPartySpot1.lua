...
local LottoPartySpot1 = class("LottoPartySpot1", util_require("base.BaseView"))
...
function LottoPartySpot1:initUI(data)
    self:createCsbNode("LottoParty_Spot_1.csb")
...
function LottoPartySpot1:setSpotNum(_num)

end

function LottoPartySpot1:resetSpot()
    self:runCsbAction(
        "idleframe",
        false,
        function()
...
function LottoPartySpot1:setSpotBetCoins(_coins)

end

function LottoPartySpot1:isMySelf(_udid)
...
function LottoPartySpot1:openSoptItem(func)
    self:runCsbAction(
        "actionframe2",
        false,
        function()
...
function LottoPartySpot1:updataSpotData(data)
...
function LottoPartySpot1:updateUI(data)
    if data and data.udid ~= "" then
...
function LottoPartySpot1:startLoadFacebookHead(fbid)
    if self.headIcon then
