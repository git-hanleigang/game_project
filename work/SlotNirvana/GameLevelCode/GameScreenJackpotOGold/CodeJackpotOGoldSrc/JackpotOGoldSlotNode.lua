...
--fixios0223
local JackpotOGoldSlotNode = class("JackpotOGoldSlotNode",require("Levels.SlotsNode"))

---
-- 传递进来的ccbName 不带有.ccbi 后缀， 主要是为了方便注册
-- symbol 对应的节点JS Controller 名字与ccbi一致
-- 
function JackpotOGoldSlotNode:initSlotNodeByCCBName(ccbName,symbolType)
...
---
-- 还原到初始被创建的状态
function JackpotOGoldSlotNode:reset()
...
--    self.p_maxRowIndex = nil
    ...
    if self.m_goldNode then
        self.m_goldNode:stopAllActions()
        self.m_goldNode:removeFromParent()
        self.m_goldNode = nil
    end
