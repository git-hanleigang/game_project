local FivePandeSlotsNode = class("FivePandeSlotsNode", util_require("Levels.SlotsNode"))

-- 切换ccb的动画名字在其它特定关卡使用
function FivePandeSlotsNode:changeCCBByName(ccbName,symbolType)
...
function FivePandeSlotsNode:resetImage()
...
---
-- 还原到初始被创建的状态
function FivePandeSlotsNode:reset()
