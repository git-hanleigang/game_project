...
local LevelTarzanFightConfig = class("LevelTarzanFightConfig", LevelConfigData)

function LevelTarzanFightConfig:ctor()
      LevelConfigData.ctor(self)
end


function LevelTarzanFightConfig:parseSelfConfigData(colKey, colValue)
...
function LevelTarzanFightConfig:getHitScoreBySymbolType( symbolType, hitCount )
      local hitScores = nil
