      ...
      _export("machine", machine = (_dec = ccclass('machine'), _dec(_class = class machine extends Component {
        ...
        startSpin() {
          ...
          for (var index = 0; index < this.colNum; index++) {
            var rollNode = this.node.getChildByName("Mask").getChildByName("reel_" + index); // let reelScript = rollNode.getComponent()
          }
        }
...
//# sourceMappingURL=19d0e92195eaaa3b3741d1d40e4d38f97089cd4b.js.map