      ...
      _export("machine", machine = (_dec = ccclass('machine'), _dec(_class = class machine extends Component {
        ...
        startSpin() {
          ...
          for (let index = 0; index < this.colNum; index++) {
            let rollNode = this.node.getChildByName("Mask").getChildByName("reel_" + index); // let reelScript = rollNode.getComponent()
          }
        }
...
//# sourceMappingURL=fe29edfc5888bd2a2f8b292c21d83ae69a98eb1e.js.map