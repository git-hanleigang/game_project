...
if nil == glView then 
    glView = cc.GLViewImpl:createWithRect("Lua Tests", cc.rect(0,0,runWidth, runHeight))
...
-- end
-- glView:setDesignResolutionSize(screenSize.width, screenSize.height, cc.ResolutionPolicy.FIXED_HEIGHT)
...
-- local tempImg = cc.Sprite:create("Images/ball.png")
