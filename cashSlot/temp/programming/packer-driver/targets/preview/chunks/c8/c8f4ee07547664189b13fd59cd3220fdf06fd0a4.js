      ...
      _export("machine", machine = (_dec = ccclass('machine'), _dec(_class = class machine extends Component {
        ...
        start() {
          ...
          for (var index = 0; index < this.colNum; index++) {
            var rollNode = this.getReelRoll(index);
            var scrip = rollNode.getComponent(_crd && reelRoll === void 0 ? (_reportPossibleCrUseOfreelRoll({
              error: Error()
            }), reelRoll) : reelRoll);
        ...
        startSpin() {
          ...
          for (var index = 0; index < this.colNum; index++) {
            var rollNode = this.getReelRoll(index);
            var reelScript = rollNode.getComponent(_crd && reelRoll === void 0 ? (_reportPossibleCrUseOfreelRoll({
              error: Error()
            }), reelRoll) : reelRoll);
...
//# sourceMappingURL=c8f4ee07547664189b13fd59cd3220fdf06fd0a4.js.map